		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getImplicitEqInterfaceGroupDefinitionAccess().getGroup_2(), "rule__ImplicitEqInterfaceGroupDefinition__Group_2__0");
					put(grammarAccess.getImplicitEqInterfaceGroupDefinitionAttributesAndValuesAccess().getGroup(), "rule__ImplicitEqInterfaceGroupDefinitionAttributesAndValues__Group__0");
					...
					put(grammarAccess.getAssistModelAccess().getNameAssignment_4(), "rule__AssistModel__NameAssignment_4");
					...
					put(grammarAccess.getEqInterfaceGroupAccess().getImplicitGroupDefinitionsAssignment_3_1(), "rule__EqInterfaceGroup__ImplicitGroupDefinitionsAssignment_3_1");
					...
					put(grammarAccess.getEqInterfaceGroupAccess().getImplicitGroupDefinitionsAssignment_4_1_1(), "rule__EqInterfaceGroup__ImplicitGroupDefinitionsAssignment_4_1_1");
					put(grammarAccess.getImplicitEqInterfaceGroupDefinitionAccess().getEntriesAssignment_1(), "rule__ImplicitEqInterfaceGroupDefinition__EntriesAssignment_1");
					put(grammarAccess.getImplicitEqInterfaceGroupDefinitionAccess().getEntriesAssignment_2_1(), "rule__ImplicitEqInterfaceGroupDefinition__EntriesAssignment_2_1");
					put(grammarAccess.getImplicitEqInterfaceGroupDefinitionAttributesAndValuesAccess().getAttributeAssignment_0(), "rule__ImplicitEqInterfaceGroupDefinitionAttributesAndValues__AttributeAssignment_0");
					put(grammarAccess.getImplicitEqInterfaceGroupDefinitionAttributesAndValuesAccess().getValueAssignment_2(), "rule__ImplicitEqInterfaceGroupDefinitionAttributesAndValues__ValueAssignment_2");
