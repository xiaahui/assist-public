		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getBoardAccess().getGroup_7(), "rule__Board__Group_7__0");
					...
					put(grammarAccess.getBoardAccess().getGroup_10(), "rule__Board__Group_10__0");
					put(grammarAccess.getBoardAccess().getGroup_13(), "rule__Board__Group_13__0");
					...
					put(grammarAccess.getApplicationAccess().getGroup_11_5(), "rule__Application__Group_11_5__0");
					...
					put(grammarAccess.getBoardAccess().getSideAssignment_7_2(), "rule__Board__SideAssignment_7_2");
					put(grammarAccess.getBoardAccess().getEssAssignment_8_2(), "rule__Board__EssAssignment_8_2");
					put(grammarAccess.getBoardAccess().getRamCapacityAssignment_9_2(), "rule__Board__RamCapacityAssignment_9_2");
					put(grammarAccess.getBoardAccess().getRomCapacityAssignment_10_2(), "rule__Board__RomCapacityAssignment_10_2");
					put(grammarAccess.getBoardAccess().getProcessorsAssignment_11(), "rule__Board__ProcessorsAssignment_11");
					put(grammarAccess.getBoardAccess().getIoAdaptersAssignment_12(), "rule__Board__IoAdaptersAssignment_12");
					put(grammarAccess.getBoardAccess().getMetricParametersAssignment_13_2(), "rule__Board__MetricParametersAssignment_13_2");
					...
					put(grammarAccess.getApplicationAccess().getRamUtilizationAssignment_4_4(), "rule__Application__RamUtilizationAssignment_4_4");
					put(grammarAccess.getApplicationAccess().getRomUtilizationAssignment_5_4(), "rule__Application__RomUtilizationAssignment_5_4");
					put(grammarAccess.getApplicationAccess().getCriticalityLevelAssignment_6_3(), "rule__Application__CriticalityLevelAssignment_6_3");
					put(grammarAccess.getApplicationAccess().getIoAdapterProtectionLevelAssignment_7_4(), "rule__Application__IoAdapterProtectionLevelAssignment_7_4");
					put(grammarAccess.getApplicationAccess().getParallelThreadsAssignment_8_4(), "rule__Application__ParallelThreadsAssignment_8_4");
					...
					put(grammarAccess.getApplicationAccess().getRestrictMappingToHardwareElementsAssignment_11_4(), "rule__Application__RestrictMappingToHardwareElementsAssignment_11_4");
					put(grammarAccess.getApplicationAccess().getRestrictMappingToHardwareElementsAssignment_11_5_1(), "rule__Application__RestrictMappingToHardwareElementsAssignment_11_5_1");
					...
					put(grammarAccess.getProximityRelationAccess().getHardwareLevelAssignment_4(), "rule__ProximityRelation__HardwareLevelAssignment_4");
					...
					put(grammarAccess.getDissimilarityRelationAccess().getDissimilarityClauseAssignment_5(), "rule__DissimilarityRelation__DissimilarityClauseAssignment_5");
