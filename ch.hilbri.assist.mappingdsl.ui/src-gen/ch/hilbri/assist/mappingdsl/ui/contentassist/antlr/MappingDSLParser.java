		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getAssistModelAccess().getAlternatives_10_2_2(), "rule__AssistModel__Alternatives_10_2_2");
					put(grammarAccess.getAssistModelAccess().getAlternatives_10_2_3(), "rule__AssistModel__Alternatives_10_2_3");
					put(grammarAccess.getEqInterfaceGroupWithImplicitDefinitionAccess().getAlternatives_3(), "rule__EqInterfaceGroupWithImplicitDefinition__Alternatives_3");
					put(grammarAccess.getEqInterfaceGroupWithImplicitDefinitionAccess().getAlternatives_4_1(), "rule__EqInterfaceGroupWithImplicitDefinition__Alternatives_4_1");
					put(grammarAccess.getValidDeploymentAccess().getAlternatives_3(), "rule__ValidDeployment__Alternatives_3");
					put(grammarAccess.getValidDeploymentImplicitAccess().getAlternatives_4(), "rule__ValidDeploymentImplicit__Alternatives_4");
					put(grammarAccess.getValidDeploymentImplicitAccess().getAlternatives_5_1(), "rule__ValidDeploymentImplicit__Alternatives_5_1");
					put(grammarAccess.getInvalidDeploymentAccess().getAlternatives_3(), "rule__InvalidDeployment__Alternatives_3");
					put(grammarAccess.getInvalidDeploymentImplicitAccess().getAlternatives_4(), "rule__InvalidDeploymentImplicit__Alternatives_4");
					put(grammarAccess.getInvalidDeploymentImplicitAccess().getAlternatives_5_1(), "rule__InvalidDeploymentImplicit__Alternatives_5_1");
					...
					put(grammarAccess.getValidDeploymentImplicitAccess().getGroup(), "rule__ValidDeploymentImplicit__Group__0");
					put(grammarAccess.getValidDeploymentImplicitAccess().getGroup_2(), "rule__ValidDeploymentImplicit__Group_2__0");
					put(grammarAccess.getValidDeploymentImplicitAccess().getGroup_5(), "rule__ValidDeploymentImplicit__Group_5__0");
					...
					put(grammarAccess.getInvalidDeploymentImplicitAccess().getGroup(), "rule__InvalidDeploymentImplicit__Group__0");
					put(grammarAccess.getInvalidDeploymentImplicitAccess().getGroup_2(), "rule__InvalidDeploymentImplicit__Group_2__0");
					put(grammarAccess.getInvalidDeploymentImplicitAccess().getGroup_5(), "rule__InvalidDeploymentImplicit__Group_5__0");
					...
					put(grammarAccess.getAssistModelAccess().getEqInterfaceGroupsAssignment_9_2_2(), "rule__AssistModel__EqInterfaceGroupsAssignment_9_2_2");
					...
					put(grammarAccess.getAssistModelAccess().getValidDeploymentsAssignment_10_2_2_0(), "rule__AssistModel__ValidDeploymentsAssignment_10_2_2_0");
					put(grammarAccess.getAssistModelAccess().getValidDeploymentsAssignment_10_2_2_1(), "rule__AssistModel__ValidDeploymentsAssignment_10_2_2_1");
					put(grammarAccess.getAssistModelAccess().getInvalidDeploymentsAssignment_10_2_3_0(), "rule__AssistModel__InvalidDeploymentsAssignment_10_2_3_0");
					put(grammarAccess.getAssistModelAccess().getInvalidDeploymentsAssignment_10_2_3_1(), "rule__AssistModel__InvalidDeploymentsAssignment_10_2_3_1");
					...
					put(grammarAccess.getEqInterfaceGroupWithImplicitDefinitionAccess().getDefinitionsAssignment_3_0(), "rule__EqInterfaceGroupWithImplicitDefinition__DefinitionsAssignment_3_0");
					put(grammarAccess.getEqInterfaceGroupWithImplicitDefinitionAccess().getEqInterfacesAssignment_3_1(), "rule__EqInterfaceGroupWithImplicitDefinition__EqInterfacesAssignment_3_1");
					put(grammarAccess.getEqInterfaceGroupWithImplicitDefinitionAccess().getDefinitionsAssignment_4_1_0(), "rule__EqInterfaceGroupWithImplicitDefinition__DefinitionsAssignment_4_1_0");
					put(grammarAccess.getEqInterfaceGroupWithImplicitDefinitionAccess().getEqInterfacesAssignment_4_1_1(), "rule__EqInterfaceGroupWithImplicitDefinition__EqInterfacesAssignment_4_1_1");
					...
					put(grammarAccess.getValidDeploymentImplicitAccess().getEqInterfaceOrGroupsAssignment_1(), "rule__ValidDeploymentImplicit__EqInterfaceOrGroupsAssignment_1");
					put(grammarAccess.getValidDeploymentImplicitAccess().getEqInterfaceOrGroupsAssignment_2_1(), "rule__ValidDeploymentImplicit__EqInterfaceOrGroupsAssignment_2_1");
					put(grammarAccess.getValidDeploymentImplicitAccess().getDefinitionsAssignment_4_0(), "rule__ValidDeploymentImplicit__DefinitionsAssignment_4_0");
					put(grammarAccess.getValidDeploymentImplicitAccess().getHardwareElementsAssignment_4_1(), "rule__ValidDeploymentImplicit__HardwareElementsAssignment_4_1");
					put(grammarAccess.getValidDeploymentImplicitAccess().getDefinitionsAssignment_5_1_0(), "rule__ValidDeploymentImplicit__DefinitionsAssignment_5_1_0");
					put(grammarAccess.getValidDeploymentImplicitAccess().getHardwareElementsAssignment_5_1_1(), "rule__ValidDeploymentImplicit__HardwareElementsAssignment_5_1_1");
					...
					put(grammarAccess.getInvalidDeploymentImplicitAccess().getEqInterfaceOrGroupsAssignment_1(), "rule__InvalidDeploymentImplicit__EqInterfaceOrGroupsAssignment_1");
					put(grammarAccess.getInvalidDeploymentImplicitAccess().getEqInterfaceOrGroupsAssignment_2_1(), "rule__InvalidDeploymentImplicit__EqInterfaceOrGroupsAssignment_2_1");
					put(grammarAccess.getInvalidDeploymentImplicitAccess().getDefinitionsAssignment_4_0(), "rule__InvalidDeploymentImplicit__DefinitionsAssignment_4_0");
					put(grammarAccess.getInvalidDeploymentImplicitAccess().getHardwareElementsAssignment_4_1(), "rule__InvalidDeploymentImplicit__HardwareElementsAssignment_4_1");
					put(grammarAccess.getInvalidDeploymentImplicitAccess().getDefinitionsAssignment_5_1_0(), "rule__InvalidDeploymentImplicit__DefinitionsAssignment_5_1_0");
					put(grammarAccess.getInvalidDeploymentImplicitAccess().getHardwareElementsAssignment_5_1_1(), "rule__InvalidDeploymentImplicit__HardwareElementsAssignment_5_1_1");
					put(grammarAccess.getDeploymentImplicitDefinitionAccess().getAttributeAssignment_0(), "rule__DeploymentImplicitDefinition__AttributeAssignment_0");
					put(grammarAccess.getDeploymentImplicitDefinitionAccess().getValueAssignment_2(), "rule__DeploymentImplicitDefinition__ValueAssignment_2");
