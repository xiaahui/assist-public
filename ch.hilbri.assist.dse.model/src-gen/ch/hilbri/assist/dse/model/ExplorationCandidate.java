 ...
 * </p>
 * <ul>
 *   <li>{@link ch.hilbri.assist.dse.model.ExplorationCandidate#getName <em>Name</em>}</li>
 *   <li>{@link ch.hilbri.assist.dse.model.ExplorationCandidate#getBoardAlternatives <em>Board Alternatives</em>}</li>
 *   <li>{@link ch.hilbri.assist.dse.model.ExplorationCandidate#getApplicationAlternatives <em>Application Alternatives</em>}</li>
 *   <li>{@link ch.hilbri.assist.dse.model.ExplorationCandidate#getRestrictionAlternatives <em>Restriction Alternatives</em>}</li>
 * </ul>
 *
 * @see ch.hilbri.assist.dse.model.ModelPackage#getExplorationCandidate()
 * @model
 * @generated
 */
public interface ExplorationCandidate extends EObject {
	 ...
	 * @see #setName(String)
	 * @see ch.hilbri.assist.dse.model.ModelPackage#getExplorationCandidate_Name()
	 * @model unique="false"
	 * @generated
	 */
	String getName();
	...
	/**
	 * Sets the value of the '{@link ch.hilbri.assist.dse.model.ExplorationCandidate#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ch.hilbri.assist.dse.model.ModelPackage#getExplorationCandidate_BoardAlternatives()
	 * @model
	 * @generated
	 */
	 ...
	 * @see ch.hilbri.assist.dse.model.ModelPackage#getExplorationCandidate_ApplicationAlternatives()
	 * @model
	 * @generated
	 */
	 ...
	 * @see ch.hilbri.assist.dse.model.ModelPackage#getExplorationCandidate_RestrictionAlternatives()
	 * @model
	 * @generated
	 */
