 ...
 * <ul>
 *   <li>{@link ch.hilbri.assist.DissimilarityConjunction#getDissimilarityClauses <em>Dissimilarity Clauses</em>}</li>
 * </ul>
 * </p>
 *
 * @see ch.hilbri.assist.AssistPackage#getDissimilarityConjunction()
 * @model
 * @generated
 */
public interface DissimilarityConjunction extends DissimilarityClause {
	 ...
	 * @see ch.hilbri.assist.AssistPackage#getDissimilarityConjunction_DissimilarityClauses()
