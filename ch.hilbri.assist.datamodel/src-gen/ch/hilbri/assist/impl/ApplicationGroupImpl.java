 ...
 * <ul>
 *   <li>{@link ch.hilbri.assist.impl.ApplicationGroupImpl#getName <em>Name</em>}</li>
 *   <li>{@link ch.hilbri.assist.impl.ApplicationGroupImpl#getApplications <em>Applications</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ApplicationGroupImpl extends ApplicationOrApplicationGroupImpl implements ApplicationGroup {
	...
	protected EClass eStaticClass() {
		return AssistPackage.Literals.APPLICATION_GROUP;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AssistPackage.APPLICATION_GROUP__NAME, oldName, name));
	}
	...
	public EList<Application> getApplications() {
		if (applications == null) {
			applications = new EObjectResolvingEList<Application>(Application.class, this, AssistPackage.APPLICATION_GROUP__APPLICATIONS);
		}
		return applications;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AssistPackage.APPLICATION_GROUP__NAME:
				return getName();
			case AssistPackage.APPLICATION_GROUP__APPLICATIONS:
