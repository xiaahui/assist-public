 ...
 * <ul>
 *   <li>{@link ch.hilbri.assist.impl.BoardImpl#getManufacturer <em>Manufacturer</em>}</li>
 *   <li>{@link ch.hilbri.assist.impl.BoardImpl#getBoardType <em>Board Type</em>}</li>
 *   <li>{@link ch.hilbri.assist.impl.BoardImpl#getPowerSupply <em>Power Supply</em>}</li>
 *   <li>{@link ch.hilbri.assist.impl.BoardImpl#getAssuranceLevel <em>Assurance Level</em>}</li>
 *   <li>{@link ch.hilbri.assist.impl.BoardImpl#getRamCapacity <em>Ram Capacity</em>}</li>
 *   <li>{@link ch.hilbri.assist.impl.BoardImpl#getRomCapacity <em>Rom Capacity</em>}</li>
 *   <li>{@link ch.hilbri.assist.impl.BoardImpl#getBox <em>Box</em>}</li>
 *   <li>{@link ch.hilbri.assist.impl.BoardImpl#getProcessors <em>Processors</em>}</li>
 *   <li>{@link ch.hilbri.assist.impl.BoardImpl#getIoAdapters <em>Io Adapters</em>}</li>
 *   <li>{@link ch.hilbri.assist.impl.BoardImpl#getMetricParameters <em>Metric Parameters</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BoardImpl extends HardwareElementContainerImpl implements Board {
	...
	protected BoardImpl() {
		super();
		this.level = HardwareArchitectureLevelType.BOARD;
	}
	...
	protected EClass eStaticClass() {
		return AssistPackage.Literals.BOARD;
	}
	...
	public void setManufacturer(String newManufacturer) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AssistPackage.BOARD__MANUFACTURER, oldManufacturer, manufacturer));
	}
	...
	public void setBoardType(String newBoardType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AssistPackage.BOARD__BOARD_TYPE, oldBoardType, boardType));
	}
	...
	public void setPowerSupply(String newPowerSupply) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AssistPackage.BOARD__POWER_SUPPLY, oldPowerSupply, powerSupply));
	}
	...
	public void setAssuranceLevel(DesignAssuranceLevelType newAssuranceLevel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AssistPackage.BOARD__ASSURANCE_LEVEL, oldAssuranceLevel, assuranceLevel));
	}
	...
	public void setRamCapacity(int newRamCapacity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AssistPackage.BOARD__RAM_CAPACITY, oldRamCapacity, ramCapacity));
	}
	...
	public void setRomCapacity(int newRomCapacity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AssistPackage.BOARD__ROM_CAPACITY, oldRomCapacity, romCapacity));
	}
	 ...
	 */
	public Box getBox() {
		if (eContainerFeatureID() != AssistPackage.BOARD__BOX) return null;
	...
	public NotificationChain basicSetBox(Box newBox, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newBox, AssistPackage.BOARD__BOX, msgs);
		return msgs;
	}
	...
	public void setBox(Box newBox) {
		if (newBox != eInternalContainer() || (eContainerFeatureID() != AssistPackage.BOARD__BOX && newBox != null)) {
			...
			if (newBox != null)
				msgs = ((InternalEObject)newBox).eInverseAdd(this, AssistPackage.BOX__BOARDS, Box.class, msgs);
			msgs = basicSetBox(newBox, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AssistPackage.BOARD__BOX, newBox, newBox));
	}
	...
	public EList<Processor> getProcessors() {
		if (processors == null) {
			processors = new EObjectContainmentWithInverseEList<Processor>(Processor.class, this, AssistPackage.BOARD__PROCESSORS, AssistPackage.PROCESSOR__BOARD);
		}
		return processors;
	}
	...
	public EList<IOAdapter> getIoAdapters() {
		if (ioAdapters == null) {
			ioAdapters = new EObjectContainmentEList<IOAdapter>(IOAdapter.class, this, AssistPackage.BOARD__IO_ADAPTERS);
		}
		return ioAdapters;
	}
	...
	public EList<MetricParameter> getMetricParameters() {
		if (metricParameters == null) {
			metricParameters = new EObjectContainmentEList<MetricParameter>(MetricParameter.class, this, AssistPackage.BOARD__METRIC_PARAMETERS);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AssistPackage.BOARD__BOX:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
				return basicSetBox((Box)otherEnd, msgs);
			case AssistPackage.BOARD__PROCESSORS:
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case AssistPackage.BOARD__IO_ADAPTERS:
				return ((InternalEList<?>)getIoAdapters()).basicRemove(otherEnd, msgs);
			case AssistPackage.BOARD__METRIC_PARAMETERS:
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case AssistPackage.BOARD__BOX:
				return eInternalContainer().eInverseRemove(this, AssistPackage.BOX__BOARDS, Box.class, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AssistPackage.BOARD__MANUFACTURER:
				return getManufacturer();
			case AssistPackage.BOARD__BOARD_TYPE:
				return getBoardType();
			case AssistPackage.BOARD__POWER_SUPPLY:
				return getPowerSupply();
			case AssistPackage.BOARD__ASSURANCE_LEVEL:
				return getAssuranceLevel();
			case AssistPackage.BOARD__RAM_CAPACITY:
				return getRamCapacity();
			case AssistPackage.BOARD__ROM_CAPACITY:
