 ...
 * <ul>
 *   <li>{@link ch.hilbri.assist.impl.HardwareElementImpl#getName <em>Name</em>}</li>
 *   <li>{@link ch.hilbri.assist.impl.HardwareElementImpl#getLevel <em>Level</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class HardwareElementImpl extends MinimalEObjectImpl.Container implements HardwareElement {
	...
	protected EClass eStaticClass() {
		return AssistPackage.Literals.HARDWARE_ELEMENT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AssistPackage.HARDWARE_ELEMENT__NAME, oldName, name));
	}
	...
	public void setLevel(HardwareArchitectureLevelType newLevel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AssistPackage.HARDWARE_ELEMENT__LEVEL, oldLevel, level));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AssistPackage.HARDWARE_ELEMENT__NAME:
				return getName();
			case AssistPackage.HARDWARE_ELEMENT__LEVEL:
				return getLevel();
		}
