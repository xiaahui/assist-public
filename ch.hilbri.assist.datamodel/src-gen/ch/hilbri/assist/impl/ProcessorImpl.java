 ...
 * <ul>
 *   <li>{@link ch.hilbri.assist.impl.ProcessorImpl#getManufacturer <em>Manufacturer</em>}</li>
 *   <li>{@link ch.hilbri.assist.impl.ProcessorImpl#getProcessorType <em>Processor Type</em>}</li>
 *   <li>{@link ch.hilbri.assist.impl.ProcessorImpl#getBoard <em>Board</em>}</li>
 *   <li>{@link ch.hilbri.assist.impl.ProcessorImpl#getCores <em>Cores</em>}</li>
 *   <li>{@link ch.hilbri.assist.impl.ProcessorImpl#getMetricParameters <em>Metric Parameters</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ProcessorImpl extends HardwareElementImpl implements Processor {
	...
	protected EClass eStaticClass() {
		return AssistPackage.Literals.PROCESSOR;
	}
	...
	public void setManufacturer(String newManufacturer) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AssistPackage.PROCESSOR__MANUFACTURER, oldManufacturer, manufacturer));
	}
	...
	public void setProcessorType(String newProcessorType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AssistPackage.PROCESSOR__PROCESSOR_TYPE, oldProcessorType, processorType));
	}
	...
	public Board getBoard() {
		if (eContainerFeatureID() != AssistPackage.PROCESSOR__BOARD) return null;
	...
	public NotificationChain basicSetBoard(Board newBoard, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newBoard, AssistPackage.PROCESSOR__BOARD, msgs);
		return msgs;
	}
	...
	public void setBoard(Board newBoard) {
		if (newBoard != eInternalContainer() || (eContainerFeatureID() != AssistPackage.PROCESSOR__BOARD && newBoard != null)) {
			...
			if (newBoard != null)
				msgs = ((InternalEObject)newBoard).eInverseAdd(this, AssistPackage.BOARD__PROCESSORS, Board.class, msgs);
			msgs = basicSetBoard(newBoard, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AssistPackage.PROCESSOR__BOARD, newBoard, newBoard));
	}
	...
	public EList<Core> getCores() {
		if (cores == null) {
			cores = new EObjectContainmentWithInverseEList<Core>(Core.class, this, AssistPackage.PROCESSOR__CORES, AssistPackage.CORE__PROCESSOR);
		}
		return cores;
	}
	...
	public EList<MetricParameter> getMetricParameters() {
		if (metricParameters == null) {
			metricParameters = new EObjectContainmentEList<MetricParameter>(MetricParameter.class, this, AssistPackage.PROCESSOR__METRIC_PARAMETERS);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AssistPackage.PROCESSOR__BOARD:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
				return basicSetBoard((Board)otherEnd, msgs);
			case AssistPackage.PROCESSOR__CORES:
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case AssistPackage.PROCESSOR__METRIC_PARAMETERS:
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case AssistPackage.PROCESSOR__BOARD:
				return eInternalContainer().eInverseRemove(this, AssistPackage.BOARD__PROCESSORS, Board.class, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AssistPackage.PROCESSOR__MANUFACTURER:
				return getManufacturer();
			case AssistPackage.PROCESSOR__PROCESSOR_TYPE:
