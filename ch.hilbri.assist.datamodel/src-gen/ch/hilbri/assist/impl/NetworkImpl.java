 ...
 * <ul>
 *   <li>{@link ch.hilbri.assist.impl.NetworkImpl#getName <em>Name</em>}</li>
 *   <li>{@link ch.hilbri.assist.impl.NetworkImpl#getBandwidthCapacity <em>Bandwidth Capacity</em>}</li>
 *   <li>{@link ch.hilbri.assist.impl.NetworkImpl#getBoards <em>Boards</em>}</li>
 *   <li>{@link ch.hilbri.assist.impl.NetworkImpl#getMetricParameters <em>Metric Parameters</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class NetworkImpl extends MinimalEObjectImpl.Container implements Network {
	...
	protected EClass eStaticClass() {
		return AssistPackage.Literals.NETWORK;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AssistPackage.NETWORK__NAME, oldName, name));
	}
	...
	public void setBandwidthCapacity(int newBandwidthCapacity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AssistPackage.NETWORK__BANDWIDTH_CAPACITY, oldBandwidthCapacity, bandwidthCapacity));
	}
	...
	public EList<Board> getBoards() {
		if (boards == null) {
			boards = new EObjectResolvingEList<Board>(Board.class, this, AssistPackage.NETWORK__BOARDS);
		}
		return boards;
	}
	...
	public EList<MetricParameter> getMetricParameters() {
		if (metricParameters == null) {
			metricParameters = new EObjectContainmentEList<MetricParameter>(MetricParameter.class, this, AssistPackage.NETWORK__METRIC_PARAMETERS);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AssistPackage.NETWORK__METRIC_PARAMETERS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AssistPackage.NETWORK__NAME:
				return getName();
			case AssistPackage.NETWORK__BANDWIDTH_CAPACITY:
				return getBandwidthCapacity();
			case AssistPackage.NETWORK__BOARDS:
				return getBoards();
			case AssistPackage.NETWORK__METRIC_PARAMETERS:
