 ...
 * <ul>
 *   <li>{@link ch.hilbri.assist.impl.DissimilarityDisjunctionImpl#getDissimilarityClauses <em>Dissimilarity Clauses</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DissimilarityDisjunctionImpl extends DissimilarityClauseImpl implements DissimilarityDisjunction {
	...
	protected EClass eStaticClass() {
		return AssistPackage.Literals.DISSIMILARITY_DISJUNCTION;
	}
	...
	public EList<DissimilarityClause> getDissimilarityClauses() {
		if (dissimilarityClauses == null) {
			dissimilarityClauses = new EObjectContainmentEList<DissimilarityClause>(DissimilarityClause.class, this, AssistPackage.DISSIMILARITY_DISJUNCTION__DISSIMILARITY_CLAUSES);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AssistPackage.DISSIMILARITY_DISJUNCTION__DISSIMILARITY_CLAUSES:
