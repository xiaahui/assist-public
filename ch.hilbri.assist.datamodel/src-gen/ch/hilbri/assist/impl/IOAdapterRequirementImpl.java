 ...
 * <ul>
 *   <li>{@link ch.hilbri.assist.impl.IOAdapterRequirementImpl#getAdapterType <em>Adapter Type</em>}</li>
 *   <li>{@link ch.hilbri.assist.impl.IOAdapterRequirementImpl#getRequiredUnits <em>Required Units</em>}</li>
 *   <li>{@link ch.hilbri.assist.impl.IOAdapterRequirementImpl#isIsSharedAllowed <em>Is Shared Allowed</em>}</li>
 *   <li>{@link ch.hilbri.assist.impl.IOAdapterRequirementImpl#isIsExclusiveOnly <em>Is Exclusive Only</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IOAdapterRequirementImpl extends MinimalEObjectImpl.Container implements IOAdapterRequirement {
	...
	protected EClass eStaticClass() {
		return AssistPackage.Literals.IO_ADAPTER_REQUIREMENT;
	}
	...
	public void setAdapterType(IOAdapterType newAdapterType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AssistPackage.IO_ADAPTER_REQUIREMENT__ADAPTER_TYPE, oldAdapterType, adapterType));
	}
	...
	public void setRequiredUnits(int newRequiredUnits) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AssistPackage.IO_ADAPTER_REQUIREMENT__REQUIRED_UNITS, oldRequiredUnits, requiredUnits));
	}
	...
	public void setIsSharedAllowed(boolean newIsSharedAllowed) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AssistPackage.IO_ADAPTER_REQUIREMENT__IS_SHARED_ALLOWED, oldIsSharedAllowed, isSharedAllowed));
	}
	...
	public void setIsExclusiveOnly(boolean newIsExclusiveOnly) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AssistPackage.IO_ADAPTER_REQUIREMENT__IS_EXCLUSIVE_ONLY, oldIsExclusiveOnly, isExclusiveOnly));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AssistPackage.IO_ADAPTER_REQUIREMENT__ADAPTER_TYPE:
				return getAdapterType();
			case AssistPackage.IO_ADAPTER_REQUIREMENT__REQUIRED_UNITS:
				return getRequiredUnits();
			case AssistPackage.IO_ADAPTER_REQUIREMENT__IS_SHARED_ALLOWED:
				return isIsSharedAllowed();
			case AssistPackage.IO_ADAPTER_REQUIREMENT__IS_EXCLUSIVE_ONLY:
