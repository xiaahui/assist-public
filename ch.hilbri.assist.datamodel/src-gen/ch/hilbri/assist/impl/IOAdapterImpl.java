 ...
 * <ul>
 *   <li>{@link ch.hilbri.assist.impl.IOAdapterImpl#getName <em>Name</em>}</li>
 *   <li>{@link ch.hilbri.assist.impl.IOAdapterImpl#getTotalUnitCount <em>Total Unit Count</em>}</li>
 *   <li>{@link ch.hilbri.assist.impl.IOAdapterImpl#getAdapterType <em>Adapter Type</em>}</li>
 *   <li>{@link ch.hilbri.assist.impl.IOAdapterImpl#getProtectionLevel <em>Protection Level</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IOAdapterImpl extends MinimalEObjectImpl.Container implements IOAdapter {
	...
	protected EClass eStaticClass() {
		return AssistPackage.Literals.IO_ADAPTER;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AssistPackage.IO_ADAPTER__NAME, oldName, name));
	}
	...
	public void setTotalUnitCount(int newTotalUnitCount) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AssistPackage.IO_ADAPTER__TOTAL_UNIT_COUNT, oldTotalUnitCount, totalUnitCount));
	}
	...
	public void setAdapterType(IOAdapterType newAdapterType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AssistPackage.IO_ADAPTER__ADAPTER_TYPE, oldAdapterType, adapterType));
	}
	...
	public void setProtectionLevel(IOAdapterProtectionLevelType newProtectionLevel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AssistPackage.IO_ADAPTER__PROTECTION_LEVEL, oldProtectionLevel, protectionLevel));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AssistPackage.IO_ADAPTER__NAME:
				return getName();
			case AssistPackage.IO_ADAPTER__TOTAL_UNIT_COUNT:
				return getTotalUnitCount();
			case AssistPackage.IO_ADAPTER__ADAPTER_TYPE:
				return getAdapterType();
			case AssistPackage.IO_ADAPTER__PROTECTION_LEVEL:
