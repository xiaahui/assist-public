 ...
 * <ul>
 *   <li>{@link ch.hilbri.assist.Box#getManufacturer <em>Manufacturer</em>}</li>
 *   <li>{@link ch.hilbri.assist.Box#getCompartment <em>Compartment</em>}</li>
 *   <li>{@link ch.hilbri.assist.Box#getBoards <em>Boards</em>}</li>
 *   <li>{@link ch.hilbri.assist.Box#getMetricParameters <em>Metric Parameters</em>}</li>
 * </ul>
 * </p>
 *
 * @see ch.hilbri.assist.AssistPackage#getBox()
 * @model
 * @generated
 */
public interface Box extends HardwareElementContainer {
	 ...
	 * @see ch.hilbri.assist.AssistPackage#getBox_Manufacturer()
	 * @model unique="false"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link ch.hilbri.assist.Box#getManufacturer <em>Manufacturer</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link ch.hilbri.assist.Compartment#getBoxes <em>Boxes</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see ch.hilbri.assist.AssistPackage#getBox_Compartment()
	...
	/**
	 * Sets the value of the '{@link ch.hilbri.assist.Box#getCompartment <em>Compartment</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link ch.hilbri.assist.Board#getBox <em>Box</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see ch.hilbri.assist.AssistPackage#getBox_Boards()
	 ...
	 * @see ch.hilbri.assist.AssistPackage#getBox_MetricParameters()
