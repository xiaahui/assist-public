 ...
 *   <li>{@link ch.hilbri.assist.model.impl.IOAdapterImpl#getTotalUnitCount <em>Total Unit Count</em>}</li>
 *   <li>{@link ch.hilbri.assist.model.impl.IOAdapterImpl#getAdapterType <em>Adapter Type</em>}</li>
 *   <li>{@link ch.hilbri.assist.model.impl.IOAdapterImpl#getProtectionLevel <em>Protection Level</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IOAdapterImpl extends MinimalEObjectImpl.Container implements IOAdapter {
	...
	public void setTotalUnitCount(int newTotalUnitCount) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.IO_ADAPTER__TOTAL_UNIT_COUNT, oldTotalUnitCount, totalUnitCount));
	}
