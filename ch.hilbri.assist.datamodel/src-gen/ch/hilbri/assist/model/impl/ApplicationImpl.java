 ...
 *   <li>{@link ch.hilbri.assist.model.impl.ApplicationImpl#getIoAdapterProtectionLevel <em>Io Adapter Protection Level</em>}</li>
 *   <li>{@link ch.hilbri.assist.model.impl.ApplicationImpl#getParallelThreads <em>Parallel Threads</em>}</li>
 *   <li>{@link ch.hilbri.assist.model.impl.ApplicationImpl#getDevelopedBy <em>Developed By</em>}</li>
 *   <li>{@link ch.hilbri.assist.model.impl.ApplicationImpl#getIoAdapterRequirements <em>Io Adapter Requirements</em>}</li>
 ...
 *   <li>{@link ch.hilbri.assist.model.impl.ApplicationImpl#getThreads <em>Threads</em>}</li>
...
public class ApplicationImpl extends ApplicationOrApplicationGroupImpl implements Application {
	 ...
	 * @ordered
	 */
	protected EList<ch.hilbri.assist.model.Thread> threads;
	 ...
	 * @generated
	 */
	public EList<ch.hilbri.assist.model.Thread> getThreads() {
		if (threads == null) {
			threads = new EObjectContainmentWithInverseEList<ch.hilbri.assist.model.Thread>(ch.hilbri.assist.model.Thread.class, this, ModelPackage.APPLICATION__THREADS, ModelPackage.THREAD__APPLICATION);
		}
		return threads;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case ModelPackage.APPLICATION__THREADS:
				getThreads().clear();
				getThreads().addAll((Collection<? extends ch.hilbri.assist.model.Thread>)newValue);
				return;
			case ModelPackage.APPLICATION__METRIC_PARAMETERS:
