 ...
 *   <li>{@link ch.hilbri.assist.model.impl.CoreImpl#getMetricParameters <em>Metric Parameters</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CoreImpl extends HardwareElementImpl implements Core {
	...
	public EList<MetricParameter> getMetricParameters() {
		if (metricParameters == null) {
			metricParameters = new EObjectContainmentEList<MetricParameter>(MetricParameter.class, this, ModelPackage.CORE__METRIC_PARAMETERS);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case ModelPackage.CORE__METRIC_PARAMETERS:
