 ...
 * <ul>
 *   <li>{@link ch.hilbri.assist.Processor#getManufacturer <em>Manufacturer</em>}</li>
 *   <li>{@link ch.hilbri.assist.Processor#getProcessorType <em>Processor Type</em>}</li>
 *   <li>{@link ch.hilbri.assist.Processor#getBoard <em>Board</em>}</li>
 *   <li>{@link ch.hilbri.assist.Processor#getCores <em>Cores</em>}</li>
 *   <li>{@link ch.hilbri.assist.Processor#getMetricParameters <em>Metric Parameters</em>}</li>
 * </ul>
 * </p>
 *
 * @see ch.hilbri.assist.AssistPackage#getProcessor()
 * @model
 * @generated
 */
public interface Processor extends HardwareElement {
	 ...
	 * @see ch.hilbri.assist.AssistPackage#getProcessor_Manufacturer()
	 * @model unique="false"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link ch.hilbri.assist.Processor#getManufacturer <em>Manufacturer</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ch.hilbri.assist.AssistPackage#getProcessor_ProcessorType()
	 * @model unique="false"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link ch.hilbri.assist.Processor#getProcessorType <em>Processor Type</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link ch.hilbri.assist.Board#getProcessors <em>Processors</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see #setBoard(Board)
	 * @see ch.hilbri.assist.AssistPackage#getProcessor_Board()
	...
	/**
	 * Sets the value of the '{@link ch.hilbri.assist.Processor#getBoard <em>Board</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link ch.hilbri.assist.Core}.
	 * It is bidirectional and its opposite is '{@link ch.hilbri.assist.Core#getProcessor <em>Processor</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see ch.hilbri.assist.AssistPackage#getProcessor_Cores()
	 ...
	 * @see ch.hilbri.assist.AssistPackage#getProcessor_MetricParameters()
