 ...
 * <ul>
 *   <li>{@link ch.hilbri.assist.DissimilarityRelation#getApplicationsOrGroups <em>Applications Or Groups</em>}</li>
 *   <li>{@link ch.hilbri.assist.DissimilarityRelation#getDissimilarityClause <em>Dissimilarity Clause</em>}</li>
 * </ul>
 * </p>
 *
 * @see ch.hilbri.assist.AssistPackage#getDissimilarityRelation()
 * @model
 * @generated
 */
public interface DissimilarityRelation extends EObject {
	 ...
	 * @see ch.hilbri.assist.AssistPackage#getDissimilarityRelation_ApplicationsOrGroups()
	 * @model required="true"
	 * @generated
	 */
	 ...
	 * @see ch.hilbri.assist.AssistPackage#getDissimilarityRelation_DissimilarityClause()
	...
	/**
	 * Sets the value of the '{@link ch.hilbri.assist.DissimilarityRelation#getDissimilarityClause <em>Dissimilarity Clause</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
