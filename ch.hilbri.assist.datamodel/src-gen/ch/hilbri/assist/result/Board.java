 ...
 * <ul>
 *   <li>{@link ch.hilbri.assist.result.Board#getManufacturer <em>Manufacturer</em>}</li>
 *   <li>{@link ch.hilbri.assist.result.Board#getBoardType <em>Board Type</em>}</li>
 ...
 * </p>
 *
 * @see ch.hilbri.assist.result.ResultPackage#getBoard()
 * @model
 * @generated
 */
public interface Board extends HardwareElement {
	 ...
	 * @see ch.hilbri.assist.result.ResultPackage#getBoard_Manufacturer()
	 * @model unique="false"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link ch.hilbri.assist.result.Board#getManufacturer <em>Manufacturer</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ch.hilbri.assist.result.ResultPackage#getBoard_BoardType()
	 * @model unique="false"
	 * @generated
	 */
	String getBoardType();
	...
	/**
	 * Sets the value of the '{@link ch.hilbri.assist.result.Board#getBoardType <em>Board Type</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ch.hilbri.assist.result.ResultPackage#getBoard_PowerSupply()
	 * @model unique="false"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link ch.hilbri.assist.result.Board#getPowerSupply <em>Power Supply</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Sets the value of the '{@link ch.hilbri.assist.result.Board#getAssuranceLevel <em>Assurance Level</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ch.hilbri.assist.result.ResultPackage#getBoard_RamCapacity()
	 * @model unique="false"
	 * @generated
	 */
	int getRamCapacity();
	...
	/**
	 * Sets the value of the '{@link ch.hilbri.assist.result.Board#getRamCapacity <em>Ram Capacity</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ch.hilbri.assist.result.ResultPackage#getBoard_RomCapacity()
	 * @model unique="false"
	 * @generated
	 */
	int getRomCapacity();
	...
	/**
	 * Sets the value of the '{@link ch.hilbri.assist.result.Board#getRomCapacity <em>Rom Capacity</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link ch.hilbri.assist.result.Box#getBoards <em>Boards</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see #setBox(Box)
	 * @see ch.hilbri.assist.result.ResultPackage#getBoard_Box()
	...
	/**
	 * Sets the value of the '{@link ch.hilbri.assist.result.Board#getBox <em>Box</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link ch.hilbri.assist.result.Processor}.
	 * It is bidirectional and its opposite is '{@link ch.hilbri.assist.result.Processor#getBoard <em>Board</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see ch.hilbri.assist.result.ResultPackage#getBoard_Processors()
	 ...
	 * @see ch.hilbri.assist.result.ResultPackage#getBoard_IoAdapters()
