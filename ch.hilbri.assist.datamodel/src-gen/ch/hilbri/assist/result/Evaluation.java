 ...
 * <ul>
 *   <li>{@link ch.hilbri.assist.result.Evaluation#getTotalScore <em>Total Score</em>}</li>
 *   <li>{@link ch.hilbri.assist.result.Evaluation#getIndividualScores <em>Individual Scores</em>}</li>
 *   <li>{@link ch.hilbri.assist.result.Evaluation#getMetricsUsed <em>Metrics Used</em>}</li>
 * </ul>
 * </p>
 *
 * @see ch.hilbri.assist.result.ResultPackage#getEvaluation()
 * @model
 * @generated
 */
public interface Evaluation extends EObject {
	 ...
	 * @see ch.hilbri.assist.result.ResultPackage#getEvaluation_TotalScore()
	 * @model unique="false"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link ch.hilbri.assist.result.Evaluation#getTotalScore <em>Total Score</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ch.hilbri.assist.result.ResultPackage#getEvaluation_IndividualScores()
	 * @model unique="false"
	 * @generated
	 */
	 ...
	 * The list contents are of type {@link ch.hilbri.assist.result.AbstractMetric}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see ch.hilbri.assist.result.ResultPackage#getEvaluation_MetricsUsed()
