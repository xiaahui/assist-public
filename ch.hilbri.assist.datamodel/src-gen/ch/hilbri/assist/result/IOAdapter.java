 ...
 * <ul>
 *   <li>{@link ch.hilbri.assist.result.IOAdapter#getName <em>Name</em>}</li>
 *   <li>{@link ch.hilbri.assist.result.IOAdapter#getTotalUnitCount <em>Total Unit Count</em>}</li>
 *   <li>{@link ch.hilbri.assist.result.IOAdapter#getAdapterType <em>Adapter Type</em>}</li>
 *   <li>{@link ch.hilbri.assist.result.IOAdapter#getProtectionLevel <em>Protection Level</em>}</li>
 * </ul>
 * </p>
 *
 * @see ch.hilbri.assist.result.ResultPackage#getIOAdapter()
 * @model
 * @generated
 */
public interface IOAdapter extends EObject {
	 ...
	 * @see #setName(String)
	 * @see ch.hilbri.assist.result.ResultPackage#getIOAdapter_Name()
	 * @model unique="false"
	 * @generated
	 */
	String getName();
	...
	/**
	 * Sets the value of the '{@link ch.hilbri.assist.result.IOAdapter#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ch.hilbri.assist.result.ResultPackage#getIOAdapter_TotalUnitCount()
	 * @model unique="false"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link ch.hilbri.assist.result.IOAdapter#getTotalUnitCount <em>Total Unit Count</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Sets the value of the '{@link ch.hilbri.assist.result.IOAdapter#getAdapterType <em>Adapter Type</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Sets the value of the '{@link ch.hilbri.assist.result.IOAdapter#getProtectionLevel <em>Protection Level</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
