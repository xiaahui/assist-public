 ...
 * <ul>
 *   <li>{@link ch.hilbri.assist.result.impl.BoardImpl#getManufacturer <em>Manufacturer</em>}</li>
 *   <li>{@link ch.hilbri.assist.result.impl.BoardImpl#getBoardType <em>Board Type</em>}</li>
