 ...
 *   <li>{@link ch.hilbri.assist.result.impl.ResultImpl#getRootHardwareElements <em>Root Hardware Elements</em>}</li>
 *   <li>{@link ch.hilbri.assist.result.impl.ResultImpl#getTopHardwareLevel <em>Top Hardware Level</em>}</li>
 *   <li>{@link ch.hilbri.assist.result.impl.ResultImpl#getBottomHardwareLevel <em>Bottom Hardware Level</em>}</li>
 *   <li>{@link ch.hilbri.assist.result.impl.ResultImpl#getIoAdapters <em>Io Adapters</em>}</li>
 *   <li>{@link ch.hilbri.assist.result.impl.ResultImpl#getApplicationGroups <em>Application Groups</em>}</li>
 *   <li>{@link ch.hilbri.assist.result.impl.ResultImpl#getApplications <em>Applications</em>}</li>
 *   <li>{@link ch.hilbri.assist.result.impl.ResultImpl#getThreads <em>Threads</em>}</li>
 *   <li>{@link ch.hilbri.assist.result.impl.ResultImpl#getNetworks <em>Networks</em>}</li>
 *   <li>{@link ch.hilbri.assist.result.impl.ResultImpl#getCommunications <em>Communications</em>}</li>
 *   <li>{@link ch.hilbri.assist.result.impl.ResultImpl#getEvaluation <em>Evaluation</em>}</li>
 *   <li>{@link ch.hilbri.assist.result.impl.ResultImpl#getAssistModel <em>Assist Model</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ResultImpl extends MinimalEObjectImpl.Container implements Result {
	...
	public EList<HardwareElement> getRootHardwareElements() {
		if (rootHardwareElements == null) {
			rootHardwareElements = new EObjectContainmentEList<HardwareElement>(HardwareElement.class, this, ResultPackage.RESULT__ROOT_HARDWARE_ELEMENTS);
		}
	...
	public EList<IOAdapter> getIoAdapters() {
		if (ioAdapters == null) {
			ioAdapters = new EObjectContainmentEList<IOAdapter>(IOAdapter.class, this, ResultPackage.RESULT__IO_ADAPTERS);
		}
		return ioAdapters;
	}
	...
	public EList<ApplicationGroup> getApplicationGroups() {
		if (applicationGroups == null) {
			applicationGroups = new EObjectContainmentEList<ApplicationGroup>(ApplicationGroup.class, this, ResultPackage.RESULT__APPLICATION_GROUPS);
		}
	...
	public EList<ch.hilbri.assist.result.Thread> getThreads() {
		if (threads == null) {
			threads = new EObjectContainmentEList<ch.hilbri.assist.result.Thread>(ch.hilbri.assist.result.Thread.class, this, ResultPackage.RESULT__THREADS);
		}
		return threads;
	}
	...
	public EList<CommunicationRelation> getCommunications() {
		if (communications == null) {
			communications = new EObjectContainmentEList<CommunicationRelation>(CommunicationRelation.class, this, ResultPackage.RESULT__COMMUNICATIONS);
		}
	...
	public NotificationChain basicSetEvaluation(Evaluation newEvaluation, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ResultPackage.RESULT__EVALUATION, oldEvaluation, newEvaluation);
	...
	public void setEvaluation(Evaluation newEvaluation) {
		if (newEvaluation != evaluation) {
			...
			if (evaluation != null)
				msgs = ((InternalEObject)evaluation).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ResultPackage.RESULT__EVALUATION, null, msgs);
			if (newEvaluation != null)
				msgs = ((InternalEObject)newEvaluation).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ResultPackage.RESULT__EVALUATION, null, msgs);
			msgs = basicSetEvaluation(newEvaluation, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResultPackage.RESULT__EVALUATION, newEvaluation, newEvaluation));
	}
	...
	public AssistModel getAssistModel() {
		if (assistModel != null && assistModel.eIsProxy()) {
			...
			if (assistModel != oldAssistModel) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResultPackage.RESULT__ASSIST_MODEL, oldAssistModel, assistModel));
			}
		}
		return assistModel;
	}
	...
	public void setAssistModel(AssistModel newAssistModel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResultPackage.RESULT__ASSIST_MODEL, oldAssistModel, assistModel));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ResultPackage.RESULT__TOP_HARDWARE_LEVEL:
				return getTopHardwareLevel();
			case ResultPackage.RESULT__BOTTOM_HARDWARE_LEVEL:
			...
			case ResultPackage.RESULT__ASSIST_MODEL:
