 ...
 * <ul>
 *   <li>{@link ch.hilbri.assist.result.impl.AbstractMetricImpl#getName <em>Name</em>}</li>
 *   <li>{@link ch.hilbri.assist.result.impl.AbstractMetricImpl#getWeight <em>Weight</em>}</li>
 *   <li>{@link ch.hilbri.assist.result.impl.AbstractMetricImpl#isHigherScoreIsBetter <em>Higher Score Is Better</em>}</li>
 *   <li>{@link ch.hilbri.assist.result.impl.AbstractMetricImpl#isBuiltIn <em>Built In</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class AbstractMetricImpl extends MinimalEObjectImpl.Container implements AbstractMetric {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case ResultPackage.ABSTRACT_METRIC___COMPUTE_SCORE__RESULT:
