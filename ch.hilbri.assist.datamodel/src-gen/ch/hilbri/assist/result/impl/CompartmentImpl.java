 ...
 * <ul>
 *   <li>{@link ch.hilbri.assist.result.impl.CompartmentImpl#getManufacturer <em>Manufacturer</em>}</li>
 *   <li>{@link ch.hilbri.assist.result.impl.CompartmentImpl#getPowerSupply <em>Power Supply</em>}</li>
 *   <li>{@link ch.hilbri.assist.result.impl.CompartmentImpl#getSide <em>Side</em>}</li>
 *   <li>{@link ch.hilbri.assist.result.impl.CompartmentImpl#getZone <em>Zone</em>}</li>
 *   <li>{@link ch.hilbri.assist.result.impl.CompartmentImpl#getBoxes <em>Boxes</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
