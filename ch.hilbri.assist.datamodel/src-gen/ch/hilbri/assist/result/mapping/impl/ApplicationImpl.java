 ...
 * <ul>
 *   <li>{@link ch.hilbri.assist.result.mapping.impl.ApplicationImpl#getName <em>Name</em>}</li>
 *   <li>{@link ch.hilbri.assist.result.mapping.impl.ApplicationImpl#getCoreUtilization <em>Core Utilization</em>}</li>
 *   <li>{@link ch.hilbri.assist.result.mapping.impl.ApplicationImpl#getRamUtilization <em>Ram Utilization</em>}</li>
 *   <li>{@link ch.hilbri.assist.result.mapping.impl.ApplicationImpl#getRomUtilization <em>Rom Utilization</em>}</li>
 *   <li>{@link ch.hilbri.assist.result.mapping.impl.ApplicationImpl#getCriticalityLevel <em>Criticality Level</em>}</li>
 *   <li>{@link ch.hilbri.assist.result.mapping.impl.ApplicationImpl#getIoAdapterProtectionLevel <em>Io Adapter Protection Level</em>}</li>
 *   <li>{@link ch.hilbri.assist.result.mapping.impl.ApplicationImpl#getParallelThreads <em>Parallel Threads</em>}</li>
 *   <li>{@link ch.hilbri.assist.result.mapping.impl.ApplicationImpl#getDevelopedBy <em>Developed By</em>}</li>
...
public class ApplicationImpl extends MinimalEObjectImpl.Container implements Application {
	...
	public EList<ch.hilbri.assist.result.mapping.Thread> getThreads() {
		if (threads == null) {
			threads = new EObjectContainmentWithInverseEList<ch.hilbri.assist.result.mapping.Thread>(ch.hilbri.assist.result.mapping.Thread.class, this, MappingPackage.APPLICATION__THREADS, MappingPackage.THREAD__APPLICATION);
		}
		return threads;
	}
