...
public interface Result extends EObject, Comparable<Result> {
	 ...
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='<%ch.hilbri.assist.model.HardwareArchitectureLevelType%> _topHardwareLevel = this.getTopHardwareLevel();\nboolean _equals = <%com.google.common.base.Objects%>.equal(_topHardwareLevel, <%ch.hilbri.assist.model.HardwareArchitectureLevelType%>.COMPARTMENT);\nif (_equals)\n{\n\t<%org.eclipse.emf.common.util.EList%><<%ch.hilbri.assist.result.mapping.HardwareElement%>> _rootHardwareElements = this.getRootHardwareElements();\n\tfinal <%org.eclipse.xtext.xbase.lib.Functions.Function1%><<%ch.hilbri.assist.result.mapping.HardwareElement%>, <%ch.hilbri.assist.result.mapping.Compartment%>> _function = new <%org.eclipse.xtext.xbase.lib.Functions.Function1%><<%ch.hilbri.assist.result.mapping.HardwareElement%>, <%ch.hilbri.assist.result.mapping.Compartment%>>()\n\t{\n\t\tpublic <%ch.hilbri.assist.result.mapping.Compartment%> apply(final <%ch.hilbri.assist.result.mapping.HardwareElement%> elem)\n\t\t{\n\t\t\treturn ((<%ch.hilbri.assist.result.mapping.Compartment%>) elem);\n\t\t}\n\t};\n\treturn <%org.eclipse.emf.ecore.xcore.lib.XcoreEListExtensions%>.<<%ch.hilbri.assist.result.mapping.HardwareElement%>, <%ch.hilbri.assist.result.mapping.Compartment%>>map(_rootHardwareElements, _function);\n}\nelse\n{\n\treturn new <%org.eclipse.emf.common.util.BasicEList%><<%ch.hilbri.assist.result.mapping.Compartment%>>();\n}'"
	 * @generated
	 */
	 ...
	 * <!-- end-model-doc -->
	 * @model kind="operation" unique="false"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='final <%org.eclipse.emf.common.util.BasicEList%><<%ch.hilbri.assist.result.mapping.Box%>> list = new <%org.eclipse.emf.common.util.BasicEList%><<%ch.hilbri.assist.result.mapping.Box%>>();\n<%ch.hilbri.assist.model.HardwareArchitectureLevelType%> _topHardwareLevel = this.getTopHardwareLevel();\nif (_topHardwareLevel != null)\n{\n\tswitch (_topHardwareLevel)\n\t{\n\t\tcase COMPARTMENT:\n\t\t\t<%org.eclipse.emf.common.util.EList%><<%ch.hilbri.assist.result.mapping.HardwareElement%>> _rootHardwareElements = this.getRootHardwareElements();\n\t\t\tfor (final <%ch.hilbri.assist.result.mapping.HardwareElement%> c : _rootHardwareElements)\n\t\t\t{\n\t\t\t\t<%org.eclipse.emf.common.util.EList%><<%ch.hilbri.assist.result.mapping.Box%>> _boxes = ((<%ch.hilbri.assist.result.mapping.Compartment%>) c).getBoxes();\n\t\t\t\tlist.addAll(_boxes);\n\t\t\t}\n\t\t\tbreak;\n\t\tcase BOX:\n\t\t\t<%org.eclipse.emf.common.util.EList%><<%ch.hilbri.assist.result.mapping.HardwareElement%>> _rootHardwareElements_1 = this.getRootHardwareElements();\n\t\t\tfinal <%org.eclipse.xtext.xbase.lib.Functions.Function1%><<%ch.hilbri.assist.result.mapping.HardwareElement%>, <%ch.hilbri.assist.result.mapping.Box%>> _function = new <%org.eclipse.xtext.xbase.lib.Functions.Function1%><<%ch.hilbri.assist.result.mapping.HardwareElement%>, <%ch.hilbri.assist.result.mapping.Box%>>()\n\t\t\t{\n\t\t\t\tpublic <%ch.hilbri.assist.result.mapping.Box%> apply(final <%ch.hilbri.assist.result.mapping.HardwareElement%> elem)\n\t\t\t\t{\n\t\t\t\t\treturn ((<%ch.hilbri.assist.result.mapping.Box%>) elem);\n\t\t\t\t}\n\t\t\t};\n\t\t\t<%org.eclipse.emf.common.util.EList%><<%ch.hilbri.assist.result.mapping.Box%>> _map = <%org.eclipse.emf.ecore.xcore.lib.XcoreEListExtensions%>.<<%ch.hilbri.assist.result.mapping.HardwareElement%>, <%ch.hilbri.assist.result.mapping.Box%>>map(_rootHardwareElements_1, _function);\n\t\t\tlist.addAll(_map);\n\t\t\tbreak;\n\t\tdefault:\n\t\t\tbreak;\n\t}\n}\nelse\n{\n}\nreturn list;'"
	 * @generated
	 */
	 ...
	 * <!-- end-model-doc -->
	 * @model kind="operation" unique="false"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='final <%org.eclipse.emf.common.util.BasicEList%><<%ch.hilbri.assist.result.mapping.Board%>> list = new <%org.eclipse.emf.common.util.BasicEList%><<%ch.hilbri.assist.result.mapping.Board%>>();\n<%ch.hilbri.assist.model.HardwareArchitectureLevelType%> _topHardwareLevel = this.getTopHardwareLevel();\nif (_topHardwareLevel != null)\n{\n\tswitch (_topHardwareLevel)\n\t{\n\t\tcase COMPARTMENT:\n\t\t\t<%org.eclipse.emf.common.util.EList%><<%ch.hilbri.assist.result.mapping.HardwareElement%>> _rootHardwareElements = this.getRootHardwareElements();\n\t\t\tfor (final <%ch.hilbri.assist.result.mapping.HardwareElement%> c : _rootHardwareElements)\n\t\t\t{\n\t\t\t\t<%org.eclipse.emf.common.util.EList%><<%ch.hilbri.assist.result.mapping.Board%>> _allBoards = ((<%ch.hilbri.assist.result.mapping.Compartment%>) c).getAllBoards();\n\t\t\t\tlist.addAll(_allBoards);\n\t\t\t}\n\t\t\tbreak;\n\t\tcase BOX:\n\t\t\t<%org.eclipse.emf.common.util.EList%><<%ch.hilbri.assist.result.mapping.HardwareElement%>> _rootHardwareElements_1 = this.getRootHardwareElements();\n\t\t\tfor (final <%ch.hilbri.assist.result.mapping.HardwareElement%> b : _rootHardwareElements_1)\n\t\t\t{\n\t\t\t\t<%org.eclipse.emf.common.util.EList%><<%ch.hilbri.assist.result.mapping.Board%>> _boards = ((<%ch.hilbri.assist.result.mapping.Box%>) b).getBoards();\n\t\t\t\tlist.addAll(_boards);\n\t\t\t}\n\t\t\tbreak;\n\t\tcase BOARD:\n\t\t\t<%org.eclipse.emf.common.util.EList%><<%ch.hilbri.assist.result.mapping.HardwareElement%>> _rootHardwareElements_2 = this.getRootHardwareElements();\n\t\t\tfinal <%org.eclipse.xtext.xbase.lib.Functions.Function1%><<%ch.hilbri.assist.result.mapping.HardwareElement%>, <%ch.hilbri.assist.result.mapping.Board%>> _function = new <%org.eclipse.xtext.xbase.lib.Functions.Function1%><<%ch.hilbri.assist.result.mapping.HardwareElement%>, <%ch.hilbri.assist.result.mapping.Board%>>()\n\t\t\t{\n\t\t\t\tpublic <%ch.hilbri.assist.result.mapping.Board%> apply(final <%ch.hilbri.assist.result.mapping.HardwareElement%> elem)\n\t\t\t\t{\n\t\t\t\t\treturn ((<%ch.hilbri.assist.result.mapping.Board%>) elem);\n\t\t\t\t}\n\t\t\t};\n\t\t\t<%org.eclipse.emf.common.util.EList%><<%ch.hilbri.assist.result.mapping.Board%>> _map = <%org.eclipse.emf.ecore.xcore.lib.XcoreEListExtensions%>.<<%ch.hilbri.assist.result.mapping.HardwareElement%>, <%ch.hilbri.assist.result.mapping.Board%>>map(_rootHardwareElements_2, _function);\n\t\t\tlist.addAll(_map);\n\t\t\tbreak;\n\t\tdefault:\n\t\t\tbreak;\n\t}\n}\nelse\n{\n}\nreturn list;'"
	 * @generated
	 */
	 ...
	 * <!-- end-model-doc -->
	 * @model kind="operation" unique="false"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='final <%org.eclipse.emf.common.util.BasicEList%><<%ch.hilbri.assist.result.mapping.Processor%>> list = new <%org.eclipse.emf.common.util.BasicEList%><<%ch.hilbri.assist.result.mapping.Processor%>>();\n<%ch.hilbri.assist.model.HardwareArchitectureLevelType%> _topHardwareLevel = this.getTopHardwareLevel();\nif (_topHardwareLevel != null)\n{\n\tswitch (_topHardwareLevel)\n\t{\n\t\tcase COMPARTMENT:\n\t\t\t<%org.eclipse.emf.common.util.EList%><<%ch.hilbri.assist.result.mapping.HardwareElement%>> _rootHardwareElements = this.getRootHardwareElements();\n\t\t\tfor (final <%ch.hilbri.assist.result.mapping.HardwareElement%> c : _rootHardwareElements)\n\t\t\t{\n\t\t\t\t<%org.eclipse.emf.common.util.EList%><<%ch.hilbri.assist.result.mapping.Processor%>> _allProcessors = ((<%ch.hilbri.assist.result.mapping.Compartment%>) c).getAllProcessors();\n\t\t\t\tlist.addAll(_allProcessors);\n\t\t\t}\n\t\t\tbreak;\n\t\tcase BOX:\n\t\t\t<%org.eclipse.emf.common.util.EList%><<%ch.hilbri.assist.result.mapping.HardwareElement%>> _rootHardwareElements_1 = this.getRootHardwareElements();\n\t\t\tfor (final <%ch.hilbri.assist.result.mapping.HardwareElement%> b : _rootHardwareElements_1)\n\t\t\t{\n\t\t\t\t<%org.eclipse.emf.common.util.EList%><<%ch.hilbri.assist.result.mapping.Processor%>> _allProcessors_1 = ((<%ch.hilbri.assist.result.mapping.Box%>) b).getAllProcessors();\n\t\t\t\tlist.addAll(_allProcessors_1);\n\t\t\t}\n\t\t\tbreak;\n\t\tcase BOARD:\n\t\t\t<%org.eclipse.emf.common.util.EList%><<%ch.hilbri.assist.result.mapping.HardwareElement%>> _rootHardwareElements_2 = this.getRootHardwareElements();\n\t\t\tfor (final <%ch.hilbri.assist.result.mapping.HardwareElement%> b_1 : _rootHardwareElements_2)\n\t\t\t{\n\t\t\t\t<%org.eclipse.emf.common.util.EList%><<%ch.hilbri.assist.result.mapping.Processor%>> _processors = ((<%ch.hilbri.assist.result.mapping.Board%>) b_1).getProcessors();\n\t\t\t\tlist.addAll(_processors);\n\t\t\t}\n\t\t\tbreak;\n\t\tdefault:\n\t\t\tbreak;\n\t}\n}\nelse\n{\n}\nreturn list;'"
	 * @generated
	 */
	 ...
	 * <!-- end-model-doc -->
	 * @model kind="operation" unique="false"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='final <%org.eclipse.emf.common.util.BasicEList%><<%ch.hilbri.assist.result.mapping.Core%>> list = new <%org.eclipse.emf.common.util.BasicEList%><<%ch.hilbri.assist.result.mapping.Core%>>();\n<%ch.hilbri.assist.model.HardwareArchitectureLevelType%> _topHardwareLevel = this.getTopHardwareLevel();\nif (_topHardwareLevel != null)\n{\n\tswitch (_topHardwareLevel)\n\t{\n\t\tcase COMPARTMENT:\n\t\t\t<%org.eclipse.emf.common.util.EList%><<%ch.hilbri.assist.result.mapping.HardwareElement%>> _rootHardwareElements = this.getRootHardwareElements();\n\t\t\tfor (final <%ch.hilbri.assist.result.mapping.HardwareElement%> c : _rootHardwareElements)\n\t\t\t{\n\t\t\t\t<%org.eclipse.emf.common.util.EList%><<%ch.hilbri.assist.result.mapping.Core%>> _allCores = ((<%ch.hilbri.assist.result.mapping.Compartment%>) c).getAllCores();\n\t\t\t\tlist.addAll(_allCores);\n\t\t\t}\n\t\t\tbreak;\n\t\tcase BOX:\n\t\t\t<%org.eclipse.emf.common.util.EList%><<%ch.hilbri.assist.result.mapping.HardwareElement%>> _rootHardwareElements_1 = this.getRootHardwareElements();\n\t\t\tfor (final <%ch.hilbri.assist.result.mapping.HardwareElement%> b : _rootHardwareElements_1)\n\t\t\t{\n\t\t\t\t<%org.eclipse.emf.common.util.EList%><<%ch.hilbri.assist.result.mapping.Core%>> _allCores_1 = ((<%ch.hilbri.assist.result.mapping.Box%>) b).getAllCores();\n\t\t\t\tlist.addAll(_allCores_1);\n\t\t\t}\n\t\t\tbreak;\n\t\tcase BOARD:\n\t\t\t<%org.eclipse.emf.common.util.EList%><<%ch.hilbri.assist.result.mapping.HardwareElement%>> _rootHardwareElements_2 = this.getRootHardwareElements();\n\t\t\tfor (final <%ch.hilbri.assist.result.mapping.HardwareElement%> b_1 : _rootHardwareElements_2)\n\t\t\t{\n\t\t\t\t<%org.eclipse.emf.common.util.EList%><<%ch.hilbri.assist.result.mapping.Core%>> _allCores_2 = ((<%ch.hilbri.assist.result.mapping.Board%>) b_1).getAllCores();\n\t\t\t\tlist.addAll(_allCores_2);\n\t\t\t}\n\t\t\tbreak;\n\t\tdefault:\n\t\t\tbreak;\n\t}\n}\nelse\n{\n}\nreturn list;'"
	 * @generated
	 */
