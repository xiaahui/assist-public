		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DislocalityRelation_applications_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DislocalityRelation_applications_feature", "_UI_DislocalityRelation_type"),
				 ModelPackage.Literals.DISLOCALITY_RELATION__APPLICATIONS,
				 true,
				 false,
				 true,
				 null,
