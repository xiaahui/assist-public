package ch.hilbri.assist.application.gui.parts;
...
public class AboutDialog extends TitleAreaDialog {
	...
	protected Control createDialogArea(Composite parent) {
	    ...
	    lblNewLabel.setImage(ResourceManager.getPluginImage("ch.hilbri.assist.application.gui", "icons/about.jpg"));
	    ...
	    label.setText(Platform.getBundle("ch.hilbri.assist.application.gui").getHeaders().get("Bundle-Version"));
