package ch.hilbri.assist.application.gui.classpath;
...
public void initialize(IJavaProject project, IClasspathEntry[] currentEntries) {
	...
	public boolean finish() {
		...
		newEntries[newEntries.length-1] = JavaCore.newContainerEntry(new Path("ch.hilbri.assist.application.gui.classpathContainer"));
