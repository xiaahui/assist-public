package ch.hilbri.assist.application.gui.splashHandlers;
		...
		if (version != null) {
			...
			getContent().addPaintListener(new PaintListener() {
				...
				public void paintControl(PaintEvent e) {
					...
					String versionText = "Version: " + Platform.getBundle("ch.hilbri.assist.application.gui").getHeaders().get("Bundle-Version") + "-Airbus" + 
