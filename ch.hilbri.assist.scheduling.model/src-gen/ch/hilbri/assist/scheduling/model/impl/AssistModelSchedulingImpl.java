...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Assist Model Scheduling</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 * @generated
 */
public class AssistModelSchedulingImpl extends MinimalEObjectImpl.Container implements AssistModelScheduling {
	/**
	 ...
	 * @generated
	 */
	protected AssistModelSchedulingImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ModelPackage.Literals.ASSIST_MODEL_SCHEDULING;
	}
	...
	public EList<Compartment> getCompartments() {
		if (compartments == null) {
			compartments = new EObjectContainmentEList<Compartment>(Compartment.class, this, ModelPackage.ASSIST_MODEL_SCHEDULING__COMPARTMENTS);
		}
		return compartments;
	}
	...
	public EList<Application> getApplications() {
		if (applications == null) {
			applications = new EObjectContainmentEList<Application>(Application.class, this, ModelPackage.ASSIST_MODEL_SCHEDULING__APPLICATIONS);
		}
		return applications;
	}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case ModelPackage.ASSIST_MODEL_SCHEDULING___GET_ALL_COMPARTMENTS:
				return getAllCompartments();
			case ModelPackage.ASSIST_MODEL_SCHEDULING___GET_ALL_BOXES:
				return getAllBoxes();
			case ModelPackage.ASSIST_MODEL_SCHEDULING___GET_ALL_BOARDS:
				return getAllBoards();
			case ModelPackage.ASSIST_MODEL_SCHEDULING___GET_ALL_PROCESSORS:
				return getAllProcessors();
			case ModelPackage.ASSIST_MODEL_SCHEDULING___GET_ALL_CORES:
				return getAllCores();
			case ModelPackage.ASSIST_MODEL_SCHEDULING___GET_ALL_TASKS:
				return getAllTasks();
			case ModelPackage.ASSIST_MODEL_SCHEDULING___GET_ALL_HARDWARE_ELEMENTS__INT:
