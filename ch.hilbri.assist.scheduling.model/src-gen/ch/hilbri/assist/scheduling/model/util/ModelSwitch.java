/**
 */
package ch.hilbri.assist.scheduling.model.util;
...
public class ModelSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ModelPackage.ASSIST_MODEL_SCHEDULING: {
				AssistModelScheduling assistModelScheduling = (AssistModelScheduling)theEObject;
				T result = caseAssistModelScheduling(assistModelScheduling);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Assist Model Scheduling</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Assist Model Scheduling</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseAssistModelScheduling(AssistModelScheduling object) {
		return null;
	}
