 ...
 * </p>
 * <ul>
 *   <li>{@link ch.hilbri.assist.scheduling.model.IOAdapterRequirement#getAdapterType <em>Adapter Type</em>}</li>
 *   <li>{@link ch.hilbri.assist.scheduling.model.IOAdapterRequirement#getRequiredAdapterCount <em>Required Adapter Count</em>}</li>
 *   <li>{@link ch.hilbri.assist.scheduling.model.IOAdapterRequirement#isIsSharedAllowed <em>Is Shared Allowed</em>}</li>
 *   <li>{@link ch.hilbri.assist.scheduling.model.IOAdapterRequirement#isIsExclusiveOnly <em>Is Exclusive Only</em>}</li>
 * </ul>
 *
 * @see ch.hilbri.assist.scheduling.model.ModelPackage#getIOAdapterRequirement()
 * @model
 * @generated
 */
public interface IOAdapterRequirement extends EObject {
	 ...
	 * The literals are from the enumeration {@link ch.hilbri.assist.scheduling.model.IOAdapterType}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see ch.hilbri.assist.scheduling.model.ModelPackage#getIOAdapterRequirement_AdapterType()
	...
	/**
	 * Sets the value of the '{@link ch.hilbri.assist.scheduling.model.IOAdapterRequirement#getAdapterType <em>Adapter Type</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ch.hilbri.assist.scheduling.model.ModelPackage#getIOAdapterRequirement_RequiredAdapterCount()
	...
	/**
	 * Sets the value of the '{@link ch.hilbri.assist.scheduling.model.IOAdapterRequirement#getRequiredAdapterCount <em>Required Adapter Count</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ch.hilbri.assist.scheduling.model.ModelPackage#getIOAdapterRequirement_IsSharedAllowed()
	...
	/**
	 * Sets the value of the '{@link ch.hilbri.assist.scheduling.model.IOAdapterRequirement#isIsSharedAllowed <em>Is Shared Allowed</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ch.hilbri.assist.scheduling.model.ModelPackage#getIOAdapterRequirement_IsExclusiveOnly()
	 * @model default="false" unique="false"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link ch.hilbri.assist.scheduling.model.IOAdapterRequirement#isIsExclusiveOnly <em>Is Exclusive Only</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
