 ...
 * @generated
 */
public class SimpleRelationItemProvider extends SchedulingRestrictionItemProvider {
	/**
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_SimpleRelation_tasks_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_SimpleRelation_tasks_feature", "_UI_SimpleRelation_type"),
                 ModelPackage.Literals.SIMPLE_RELATION__TASKS,
                 true,
                 false,
                 true,
                 null,
