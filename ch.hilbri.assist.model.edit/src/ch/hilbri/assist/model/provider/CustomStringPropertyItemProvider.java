...
/**
 * This is the item provider adapter for a {@link ch.hilbri.assist.model.CustomStringProperty} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CustomStringPropertyItemProvider extends CustomPropertyItemProvider {
	 ...
	 * @generated
	 */
	public CustomStringPropertyItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/CustomStringProperty"));
	}
	...
	public String getText(Object object) {
		String label = ((CustomStringProperty)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_CustomStringProperty_type") :
			getString("_UI_CustomStringProperty_type") + " " + label;
	}
