 ...
 * </p>
 * <ul>
 *   <li>{@link ch.hilbri.assist.model.impl.ColocalityRelationImpl#getApplications <em>Applications</em>}</li>
 *   <li>{@link ch.hilbri.assist.model.impl.ColocalityRelationImpl#getHardwareLevel <em>Hardware Level</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ColocalityRelationImpl extends MinimalEObjectImpl.Container implements ColocalityRelation {
	...
	public EList<Application> getApplications() {
		if (applications == null) {
			applications = new EObjectResolvingEList<Application>(Application.class, this, ModelPackage.COLOCALITY_RELATION__APPLICATIONS);
		}
		return applications;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelPackage.COLOCALITY_RELATION__APPLICATIONS:
