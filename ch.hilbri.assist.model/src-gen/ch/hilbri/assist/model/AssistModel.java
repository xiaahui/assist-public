...
public interface AssistModel extends EObject {
     ...
     * <!-- end-user-doc -->
     * @model kind="operation" unique="false"
     *        annotation="http://www.eclipse.org/emf/2002/GenModel body='final &lt;%org.eclipse.xtext.xbase.lib.Functions.Function1%&gt;&lt;&lt;%ch.hilbri.assist.model.Compartment%&gt;, &lt;%ch.hilbri.assist.model.HardwareElement%&gt;&gt; _function = new &lt;%org.eclipse.xtext.xbase.lib.Functions.Function1%&gt;&lt;&lt;%ch.hilbri.assist.model.Compartment%&gt;, &lt;%ch.hilbri.assist.model.HardwareElement%&gt;&gt;()\n{\n\tpublic &lt;%ch.hilbri.assist.model.HardwareElement%&gt; apply(final &lt;%ch.hilbri.assist.model.Compartment%&gt; it)\n\t{\n\t\treturn ((&lt;%ch.hilbri.assist.model.HardwareElement%&gt;) it);\n\t}\n};\n&lt;%org.eclipse.emf.common.util.EList%&gt;&lt;&lt;%ch.hilbri.assist.model.HardwareElement%&gt;&gt; _map = &lt;%org.eclipse.emf.ecore.xcore.lib.XcoreEListExtensions%&gt;.&lt;&lt;%ch.hilbri.assist.model.Compartment%&gt;, &lt;%ch.hilbri.assist.model.HardwareElement%&gt;&gt;map(this.getAllCompartments(), _function);\nfinal &lt;%org.eclipse.xtext.xbase.lib.Functions.Function1%&gt;&lt;&lt;%ch.hilbri.assist.model.Box%&gt;, &lt;%ch.hilbri.assist.model.HardwareElement%&gt;&gt; _function_1 = new &lt;%org.eclipse.xtext.xbase.lib.Functions.Function1%&gt;&lt;&lt;%ch.hilbri.assist.model.Box%&gt;, &lt;%ch.hilbri.assist.model.HardwareElement%&gt;&gt;()\n{\n\tpublic &lt;%ch.hilbri.assist.model.HardwareElement%&gt; apply(final &lt;%ch.hilbri.assist.model.Box%&gt; it)\n\t{\n\t\treturn ((&lt;%ch.hilbri.assist.model.HardwareElement%&gt;) it);\n\t}\n};\n&lt;%org.eclipse.emf.common.util.EList%&gt;&lt;&lt;%ch.hilbri.assist.model.HardwareElement%&gt;&gt; _map_1 = &lt;%org.eclipse.emf.ecore.xcore.lib.XcoreEListExtensions%&gt;.&lt;&lt;%ch.hilbri.assist.model.Box%&gt;, &lt;%ch.hilbri.assist.model.HardwareElement%&gt;&gt;map(this.getAllBoxes(), _function_1);\n&lt;%java.lang.Iterable%&gt;&lt;&lt;%ch.hilbri.assist.model.HardwareElement%&gt;&gt; _plus = &lt;%com.google.common.collect.Iterables%&gt;.&lt;&lt;%ch.hilbri.assist.model.HardwareElement%&gt;&gt;concat(_map, _map_1);\nfinal &lt;%org.eclipse.xtext.xbase.lib.Functions.Function1%&gt;&lt;&lt;%ch.hilbri.assist.model.Board%&gt;, &lt;%ch.hilbri.assist.model.HardwareElement%&gt;&gt; _function_2 = new &lt;%org.eclipse.xtext.xbase.lib.Functions.Function1%&gt;&lt;&lt;%ch.hilbri.assist.model.Board%&gt;, &lt;%ch.hilbri.assist.model.HardwareElement%&gt;&gt;()\n{\n\tpublic &lt;%ch.hilbri.assist.model.HardwareElement%&gt; apply(final &lt;%ch.hilbri.assist.model.Board%&gt; it)\n\t{\n\t\treturn ((&lt;%ch.hilbri.assist.model.HardwareElement%&gt;) it);\n\t}\n};\n&lt;%org.eclipse.emf.common.util.EList%&gt;&lt;&lt;%ch.hilbri.assist.model.HardwareElement%&gt;&gt; _map_2 = &lt;%org.eclipse.emf.ecore.xcore.lib.XcoreEListExtensions%&gt;.&lt;&lt;%ch.hilbri.assist.model.Board%&gt;, &lt;%ch.hilbri.assist.model.HardwareElement%&gt;&gt;map(this.getAllBoards(), _function_2);\n&lt;%java.lang.Iterable%&gt;&lt;&lt;%ch.hilbri.assist.model.HardwareElement%&gt;&gt; _plus_1 = &lt;%com.google.common.collect.Iterables%&gt;.&lt;&lt;%ch.hilbri.assist.model.HardwareElement%&gt;&gt;concat(_plus, _map_2);\nfinal &lt;%org.eclipse.xtext.xbase.lib.Functions.Function1%&gt;&lt;&lt;%ch.hilbri.assist.model.Processor%&gt;, &lt;%ch.hilbri.assist.model.HardwareElement%&gt;&gt; _function_3 = new &lt;%org.eclipse.xtext.xbase.lib.Functions.Function1%&gt;&lt;&lt;%ch.hilbri.assist.model.Processor%&gt;, &lt;%ch.hilbri.assist.model.HardwareElement%&gt;&gt;()\n{\n\tpublic &lt;%ch.hilbri.assist.model.HardwareElement%&gt; apply(final &lt;%ch.hilbri.assist.model.Processor%&gt; it)\n\t{\n\t\treturn ((&lt;%ch.hilbri.assist.model.HardwareElement%&gt;) it);\n\t}\n};\n&lt;%org.eclipse.emf.common.util.EList%&gt;&lt;&lt;%ch.hilbri.assist.model.HardwareElement%&gt;&gt; _map_3 = &lt;%org.eclipse.emf.ecore.xcore.lib.XcoreEListExtensions%&gt;.&lt;&lt;%ch.hilbri.assist.model.Processor%&gt;, &lt;%ch.hilbri.assist.model.HardwareElement%&gt;&gt;map(this.getAllProcessors(), _function_3);\n&lt;%java.lang.Iterable%&gt;&lt;&lt;%ch.hilbri.assist.model.HardwareElement%&gt;&gt; _plus_2 = &lt;%com.google.common.collect.Iterables%&gt;.&lt;&lt;%ch.hilbri.assist.model.HardwareElement%&gt;&gt;concat(_plus_1, _map_3);\nfinal &lt;%org.eclipse.xtext.xbase.lib.Functions.Function1%&gt;&lt;&lt;%ch.hilbri.assist.model.Core%&gt;, &lt;%ch.hilbri.assist.model.HardwareElement%&gt;&gt; _function_4 = new &lt;%org.eclipse.xtext.xbase.lib.Functions.Function1%&gt;&lt;&lt;%ch.hilbri.assist.model.Core%&gt;, &lt;%ch.hilbri.assist.model.HardwareElement%&gt;&gt;()\n{\n\tpublic &lt;%ch.hilbri.assist.model.HardwareElement%&gt; apply(final &lt;%ch.hilbri.assist.model.Core%&gt; it)\n\t{\n\t\treturn ((&lt;%ch.hilbri.assist.model.HardwareElement%&gt;) it);\n\t}\n};\n&lt;%org.eclipse.emf.common.util.EList%&gt;&lt;&lt;%ch.hilbri.assist.model.HardwareElement%&gt;&gt; _map_4 = &lt;%org.eclipse.emf.ecore.xcore.lib.XcoreEListExtensions%&gt;.&lt;&lt;%ch.hilbri.assist.model.Core%&gt;, &lt;%ch.hilbri.assist.model.HardwareElement%&gt;&gt;map(this.getAllCores(), _function_4);\nfinal &lt;%java.lang.Iterable%&gt;&lt;&lt;%ch.hilbri.assist.model.HardwareElement%&gt;&gt; iterables = &lt;%com.google.common.collect.Iterables%&gt;.&lt;&lt;%ch.hilbri.assist.model.HardwareElement%&gt;&gt;concat(_plus_2, _map_4);\nreturn &lt;%org.eclipse.emf.common.util.ECollections%&gt;.&lt;&lt;%ch.hilbri.assist.model.HardwareElement%&gt;&gt;toEList(iterables);'"
     * @generated
     */
