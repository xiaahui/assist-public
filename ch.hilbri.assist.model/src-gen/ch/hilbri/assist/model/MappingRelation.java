...
public interface MappingRelation extends EObject {
     ...
     *        annotation="http://www.eclipse.org/emf/2002/GenModel get='final &lt;%java.util.List%&gt;&lt;&lt;%org.eclipse.emf.common.util.EList%&gt;&lt;&lt;%ch.hilbri.assist.model.Task%&gt;&gt;&gt; list = &lt;%org.eclipse.xtext.xbase.lib.CollectionLiterals%&gt;.&lt;&lt;%org.eclipse.emf.common.util.EList%&gt;&lt;&lt;%ch.hilbri.assist.model.Task%&gt;&gt;&gt;newArrayList();\n&lt;%org.eclipse.emf.common.util.EList%&gt;&lt;&lt;%ch.hilbri.assist.model.SoftwareElement%&gt;&gt; _softwareElements = this.getSoftwareElements();\nfor (final &lt;%ch.hilbri.assist.model.SoftwareElement%&gt; se : _softwareElements)\n{\n\t{\n\t\tif ((se instanceof &lt;%ch.hilbri.assist.model.Application%&gt;))\n\t\t{\n\t\t\tlist.add(((&lt;%ch.hilbri.assist.model.Application%&gt;)se).getTasks());\n\t\t}\n\t\tif ((se instanceof &lt;%ch.hilbri.assist.model.Task%&gt;))\n\t\t{\n\t\t\tlist.add(&lt;%org.eclipse.emf.common.util.ECollections%&gt;.&lt;&lt;%ch.hilbri.assist.model.Task%&gt;&gt;toEList(java.util.Collections.&lt;&lt;%ch.hilbri.assist.model.Task%&gt;&gt;unmodifiableList(org.eclipse.xtext.xbase.lib.CollectionLiterals.&lt;&lt;%ch.hilbri.assist.model.Task%&gt;&gt;newArrayList(((&lt;%ch.hilbri.assist.model.Task%&gt;)se)))));\n\t\t}\n\t}\n}\nreturn &lt;%org.eclipse.emf.common.util.ECollections%&gt;.&lt;&lt;%org.eclipse.emf.common.util.EList%&gt;&lt;&lt;%ch.hilbri.assist.model.Task%&gt;&gt;&gt;toEList(list);'"
     * @generated
     */
     ...
     *        annotation="http://www.eclipse.org/emf/2002/GenModel get='final &lt;%java.lang.StringBuilder%&gt; output = new &lt;%java.lang.StringBuilder%&gt;();\n&lt;%org.eclipse.emf.common.util.EList%&gt;&lt;&lt;%ch.hilbri.assist.model.SoftwareElement%&gt;&gt; _softwareElements = this.getSoftwareElements();\nfor (final &lt;%ch.hilbri.assist.model.SoftwareElement%&gt; se : _softwareElements)\n{\n\t{\n\t\tif ((se instanceof &lt;%ch.hilbri.assist.model.Application%&gt;))\n\t\t{\n\t\t\toutput.append(((&lt;%ch.hilbri.assist.model.Application%&gt;)se).getName());\n\t\t}\n\t\tif ((se instanceof &lt;%ch.hilbri.assist.model.Task%&gt;))\n\t\t{\n\t\t\toutput.append(((&lt;%ch.hilbri.assist.model.Task%&gt;)se).getName());\n\t\t}\n\t\t&lt;%ch.hilbri.assist.model.SoftwareElement%&gt; _last = &lt;%org.eclipse.xtext.xbase.lib.IterableExtensions%&gt;.&lt;&lt;%ch.hilbri.assist.model.SoftwareElement%&gt;&gt;last(this.getSoftwareElements());\n\t\tboolean _notEquals = (!&lt;%com.google.common.base.Objects%&gt;.equal(se, _last));\n\t\tif (_notEquals)\n\t\t{\n\t\t\toutput.append(\", \");\n\t\t}\n\t}\n}\nreturn output.toString();'"
     * @generated
     */
