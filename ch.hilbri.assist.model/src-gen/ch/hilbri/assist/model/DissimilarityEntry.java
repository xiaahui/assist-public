...
public interface DissimilarityEntry extends DissimilarityClause {
     ...
     *        annotation="http://www.eclipse.org/emf/2002/GenModel get='&lt;%ch.hilbri.assist.model.DissimilarityAttributes%&gt; _dissimilarityAttribute = this.getDissimilarityAttribute();\nif (_dissimilarityAttribute != null)\n{\n\tswitch (_dissimilarityAttribute)\n\t{\n\t\tcase COMPARTMENT_MANUFACTURER:\n\t\t\treturn &lt;%ch.hilbri.assist.model.HardwareArchitectureLevelType%&gt;.COMPARTMENT;\n\t\tcase COMPARTMENT_POWERSUPPLY:\n\t\t\treturn &lt;%ch.hilbri.assist.model.HardwareArchitectureLevelType%&gt;.COMPARTMENT;\n\t\tcase BOX_MANUFACTURER:\n\t\t\treturn &lt;%ch.hilbri.assist.model.HardwareArchitectureLevelType%&gt;.BOX;\n\t\tcase BOARD_MANUFACTURER:\n\t\t\treturn &lt;%ch.hilbri.assist.model.HardwareArchitectureLevelType%&gt;.BOARD;\n\t\tcase BOARD_BOARDTYPE:\n\t\t\treturn &lt;%ch.hilbri.assist.model.HardwareArchitectureLevelType%&gt;.BOARD;\n\t\tcase BOARD_POWERSUPPLY:\n\t\t\treturn &lt;%ch.hilbri.assist.model.HardwareArchitectureLevelType%&gt;.BOARD;\n\t\tcase BOARD_ASSURANCELEVEL:\n\t\t\treturn &lt;%ch.hilbri.assist.model.HardwareArchitectureLevelType%&gt;.BOARD;\n\t\tcase PROCESSOR_MANUFACTURER:\n\t\t\treturn &lt;%ch.hilbri.assist.model.HardwareArchitectureLevelType%&gt;.PROCESSOR;\n\t\tcase PROCESSOR_PROCESSORTYPE:\n\t\t\treturn &lt;%ch.hilbri.assist.model.HardwareArchitectureLevelType%&gt;.PROCESSOR;\n\t\tcase CORE_ARCHITECTURE:\n\t\t\treturn &lt;%ch.hilbri.assist.model.HardwareArchitectureLevelType%&gt;.CORE;\n\t\tdefault:\n\t\t\tbreak;\n\t}\n}\nreturn null;'"
     * @generated
     */
