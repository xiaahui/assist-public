    	...
    	newLeafNode(otherlv_6, grammarAccess.getAssistModelAccess().getSemicolonKeyword_2_0_3());
			...
			( 
				{getUnorderedGroupHelper().canSelect(grammarAccess.getAssistModelAccess().getUnorderedGroup_2(), 1)}?=>(
					...
					({true}?=>(	otherlv_7='Compatible Interface Types' 
    {
...
entryRuleProtectionLevelData returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getProtectionLevelDataRule()); }
	 iv_ruleProtectionLevelData=ruleProtectionLevelData 
	 { $current=$iv_ruleProtectionLevelData.current; } 
	 EOF 
;

// Rule ProtectionLevelData
ruleProtectionLevelData returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
...
entryRuleCableWeightData returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getCableWeightDataRule()); }
	 iv_ruleCableWeightData=ruleCableWeightData 
	 { $current=$iv_ruleCableWeightData.current; } 
	 EOF 
;

// Rule CableWeightData
ruleCableWeightData returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
