...
public final class SwitchesPruningLogging {
	...
	public final static void log(boolean isEnabled, @SuppressWarnings("rawtypes") Class fromClass, String pattern, Object[] args) {
	};

	public final static void log(boolean isEnabled, @SuppressWarnings("rawtypes") Class fromClass, String pattern, Object arg1) {
	};

	public final static void log(boolean isEnabled, @SuppressWarnings("rawtypes") Class fromClass, String pattern, Object arg1, Object arg2) {
	};
