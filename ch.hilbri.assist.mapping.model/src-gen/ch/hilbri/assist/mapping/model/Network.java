 ...
 * </p>
 * <ul>
 *   <li>{@link ch.hilbri.assist.mapping.model.Network#getName <em>Name</em>}</li>
 *   <li>{@link ch.hilbri.assist.mapping.model.Network#getBandwidthCapacity <em>Bandwidth Capacity</em>}</li>
 *   <li>{@link ch.hilbri.assist.mapping.model.Network#getBoards <em>Boards</em>}</li>
 *   <li>{@link ch.hilbri.assist.mapping.model.Network#getMetricParameters <em>Metric Parameters</em>}</li>
 *   <li>{@link ch.hilbri.assist.mapping.model.Network#isIsBoardLocal <em>Is Board Local</em>}</li>
 * </ul>
 *
 * @see ch.hilbri.assist.mapping.model.ModelPackage#getNetwork()
 * @model
 * @generated
 */
public interface Network extends EObject {
	 ...
	 * @see #setName(String)
	 * @see ch.hilbri.assist.mapping.model.ModelPackage#getNetwork_Name()
	...
	/**
	 * Sets the value of the '{@link ch.hilbri.assist.mapping.model.Network#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ch.hilbri.assist.mapping.model.ModelPackage#getNetwork_BandwidthCapacity()
	...
	/**
	 * Sets the value of the '{@link ch.hilbri.assist.mapping.model.Network#getBandwidthCapacity <em>Bandwidth Capacity</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ch.hilbri.assist.mapping.model.ModelPackage#getNetwork_Boards()
	 * @model required="true"
	 * @generated
	 */
	 ...
	 * @see ch.hilbri.assist.mapping.model.ModelPackage#getNetwork_MetricParameters()
	 ...
	 * @see ch.hilbri.assist.mapping.model.ModelPackage#getNetwork_IsBoardLocal()
	 * @model unique="false" transient="true" changeable="false" volatile="true" derived="true"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel get='<%org.eclipse.emf.common.util.EList%><<%ch.hilbri.assist.mapping.model.Board%>> _boards = this.getBoards();\nint _size = _boards.size();\nboolean _equals = (_size == 1);\nif (_equals)\n{\n\treturn true;\n}\nelse\n{\n\treturn false;\n}'"
	 * @generated
	 */
