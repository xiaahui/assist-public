 ...
 * </p>
 * <ul>
 *   <li>{@link ch.hilbri.assist.mapping.model.impl.SchedulingRelationImpl#getRefBefore <em>Ref Before</em>}</li>
 *   <li>{@link ch.hilbri.assist.mapping.model.impl.SchedulingRelationImpl#getRefAfter <em>Ref After</em>}</li>
 *   <li>{@link ch.hilbri.assist.mapping.model.impl.SchedulingRelationImpl#getThreadBefore <em>Thread Before</em>}</li>
 *   <li>{@link ch.hilbri.assist.mapping.model.impl.SchedulingRelationImpl#getThreadAfter <em>Thread After</em>}</li>
 *   <li>{@link ch.hilbri.assist.mapping.model.impl.SchedulingRelationImpl#getDelay <em>Delay</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SchedulingRelationImpl extends MinimalEObjectImpl.Container implements SchedulingRelation {
	 ...
	 * @ordered
	 */
	protected ch.hilbri.assist.mapping.model.Thread threadBefore;
	 ...
	 * @ordered
	 */
	protected ch.hilbri.assist.mapping.model.Thread threadAfter;
	 ...
	 * @generated
	 */
	public ch.hilbri.assist.mapping.model.Thread getThreadBefore() {
		if (threadBefore != null && threadBefore.eIsProxy()) {
			InternalEObject oldThreadBefore = (InternalEObject)threadBefore;
			threadBefore = (ch.hilbri.assist.mapping.model.Thread)eResolveProxy(oldThreadBefore);
	 ...
	 * @generated
	 */
	public ch.hilbri.assist.mapping.model.Thread basicGetThreadBefore() {
		return threadBefore;
	}
	 ...
	 * @generated
	 */
	public void setThreadBefore(ch.hilbri.assist.mapping.model.Thread newThreadBefore) {
		ch.hilbri.assist.mapping.model.Thread oldThreadBefore = threadBefore;
	 ...
	 * @generated
	 */
	public ch.hilbri.assist.mapping.model.Thread getThreadAfter() {
		if (threadAfter != null && threadAfter.eIsProxy()) {
			InternalEObject oldThreadAfter = (InternalEObject)threadAfter;
			threadAfter = (ch.hilbri.assist.mapping.model.Thread)eResolveProxy(oldThreadAfter);
	 ...
	 * @generated
	 */
	public ch.hilbri.assist.mapping.model.Thread basicGetThreadAfter() {
		return threadAfter;
	}
	 ...
	 * @generated
	 */
	public void setThreadAfter(ch.hilbri.assist.mapping.model.Thread newThreadAfter) {
		ch.hilbri.assist.mapping.model.Thread oldThreadAfter = threadAfter;
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case ModelPackage.SCHEDULING_RELATION__REF_AFTER:
				...
				return;
			case ModelPackage.SCHEDULING_RELATION__THREAD_BEFORE:
				setThreadBefore((ch.hilbri.assist.mapping.model.Thread)newValue);
				return;
			case ModelPackage.SCHEDULING_RELATION__THREAD_AFTER:
				setThreadAfter((ch.hilbri.assist.mapping.model.Thread)newValue);
				return;
			case ModelPackage.SCHEDULING_RELATION__DELAY:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case ModelPackage.SCHEDULING_RELATION__REF_AFTER:
				...
				return;
			case ModelPackage.SCHEDULING_RELATION__THREAD_BEFORE:
				setThreadBefore((ch.hilbri.assist.mapping.model.Thread)null);
				return;
			case ModelPackage.SCHEDULING_RELATION__THREAD_AFTER:
				setThreadAfter((ch.hilbri.assist.mapping.model.Thread)null);
				return;
			case ModelPackage.SCHEDULING_RELATION__DELAY:
