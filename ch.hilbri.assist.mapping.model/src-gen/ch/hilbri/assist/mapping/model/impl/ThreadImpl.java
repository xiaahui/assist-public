 ...
 * </p>
 * <ul>
 *   <li>{@link ch.hilbri.assist.mapping.model.impl.ThreadImpl#getName <em>Name</em>}</li>
 *   <li>{@link ch.hilbri.assist.mapping.model.impl.ThreadImpl#getCoreUtilization <em>Core Utilization</em>}</li>
 *   <li>{@link ch.hilbri.assist.mapping.model.impl.ThreadImpl#getApplication <em>Application</em>}</li>
 *   <li>{@link ch.hilbri.assist.mapping.model.impl.ThreadImpl#getDuration <em>Duration</em>}</li>
 *   <li>{@link ch.hilbri.assist.mapping.model.impl.ThreadImpl#getPeriod <em>Period</em>}</li>
 *   <li>{@link ch.hilbri.assist.mapping.model.impl.ThreadImpl#getEarlyTolerance <em>Early Tolerance</em>}</li>
 *   <li>{@link ch.hilbri.assist.mapping.model.impl.ThreadImpl#getLateTolerance <em>Late Tolerance</em>}</li>
 *   <li>{@link ch.hilbri.assist.mapping.model.impl.ThreadImpl#getLatestStartTime <em>Latest Start Time</em>}</li>
 *   <li>{@link ch.hilbri.assist.mapping.model.impl.ThreadImpl#getLatestEndTime <em>Latest End Time</em>}</li>
 *   <li>{@link ch.hilbri.assist.mapping.model.impl.ThreadImpl#getInitTime <em>Init Time</em>}</li>
 *   <li>{@link ch.hilbri.assist.mapping.model.impl.ThreadImpl#getMaxSlices <em>Max Slices</em>}</li>
 *   <li>{@link ch.hilbri.assist.mapping.model.impl.ThreadImpl#getMinSliceDuration <em>Min Slice Duration</em>}</li>
 *   <li>{@link ch.hilbri.assist.mapping.model.impl.ThreadImpl#getLocation <em>Location</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ThreadImpl extends MinimalEObjectImpl.Container implements ch.hilbri.assist.mapping.model.Thread {
	/**
	...
	public String getName() {
		...
		EList<ch.hilbri.assist.mapping.model.Thread> _threads = _application_1.getThreads();
