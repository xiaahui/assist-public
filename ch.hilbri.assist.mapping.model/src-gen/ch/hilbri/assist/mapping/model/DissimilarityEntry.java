 ...
 *   <li>{@link ch.hilbri.assist.mapping.model.DissimilarityEntry#getCoreAttribute <em>Core Attribute</em>}</li>
...
public interface DissimilarityEntry extends DissimilarityClause {
	...
	/**
	 * Returns the value of the '<em><b>Core Attribute</b></em>' attribute.
	 * The default value is <code>"None"</code>.
	 * The literals are from the enumeration {@link ch.hilbri.assist.mapping.model.CoreAttributes}.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Core Attribute</em>' attribute isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Core Attribute</em>' attribute.
	 * @see ch.hilbri.assist.mapping.model.CoreAttributes
	 * @see #setCoreAttribute(CoreAttributes)
	 * @see ch.hilbri.assist.mapping.model.ModelPackage#getDissimilarityEntry_CoreAttribute()
	 * @model default="None" unique="false"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link ch.hilbri.assist.mapping.model.DissimilarityEntry#getCoreAttribute <em>Core Attribute</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param value the new value of the '<em>Core Attribute</em>' attribute.
	 * @see ch.hilbri.assist.mapping.model.CoreAttributes
	 * @see #getCoreAttribute()
	 * @generated
	 */
	void setCoreAttribute(CoreAttributes value);
