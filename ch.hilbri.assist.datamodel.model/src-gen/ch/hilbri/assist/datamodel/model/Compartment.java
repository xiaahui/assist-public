 ...
 *   <li>{@link ch.hilbri.assist.datamodel.model.Compartment#getBoxes <em>Boxes</em>}</li>
 * </ul>
 *
...
public interface Compartment extends HardwareElementContainer {
	 ...
	 * The list contents are of type {@link ch.hilbri.assist.datamodel.model.Box}.
	 * It is bidirectional and its opposite is '{@link ch.hilbri.assist.datamodel.model.Box#getCompartment <em>Compartment</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see ch.hilbri.assist.datamodel.model.ModelPackage#getCompartment_Boxes()
	 ...
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='final <%org.eclipse.emf.common.util.BasicEList%><<%ch.hilbri.assist.datamodel.model.Board%>> list = new <%org.eclipse.emf.common.util.BasicEList%><<%ch.hilbri.assist.datamodel.model.Board%>>();\n<%org.eclipse.emf.common.util.EList%><<%ch.hilbri.assist.datamodel.model.Box%>> _boxes = this.getBoxes();\nfor (final <%ch.hilbri.assist.datamodel.model.Box%> b : _boxes)\n{\n\t<%org.eclipse.emf.common.util.EList%><<%ch.hilbri.assist.datamodel.model.Board%>> _boards = b.getBoards();\n\tlist.addAll(_boards);\n}\nreturn list;'"
	 * @generated
	 */
