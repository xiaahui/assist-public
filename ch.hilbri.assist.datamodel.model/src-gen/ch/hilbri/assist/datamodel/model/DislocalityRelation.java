 ...
 * </p>
 * <ul>
 *   <li>{@link ch.hilbri.assist.datamodel.model.DislocalityRelation#getEqInterfaceOrGroups <em>Eq Interface Or Groups</em>}</li>
...
public interface DislocalityRelation extends EObject {
	 ...
	 * @see ch.hilbri.assist.datamodel.model.ModelPackage#getDislocalityRelation_EqInterfaceOrGroups()
	 * @model required="true"
	 * @generated
	 */
	 ...
	 * <!-- end-user-doc -->
	 * @model kind="operation" unique="false"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='int counter = 0;\n<%org.eclipse.emf.common.util.EList%><<%ch.hilbri.assist.datamodel.model.EqInterfaceOrGroup%>> _eqInterfaceOrGroups = this.getEqInterfaceOrGroups();\nfor (final <%ch.hilbri.assist.datamodel.model.EqInterfaceOrGroup%> e : _eqInterfaceOrGroups)\n{\n\tif ((e instanceof <%ch.hilbri.assist.datamodel.model.EqInterface%>))\n\t{\n\t\tint _counter = counter;\n\t\tcounter = (_counter + 1);\n\t}\n\telse\n\t{\n\t\tif ((e instanceof <%ch.hilbri.assist.datamodel.model.EqInterfaceGroup%>))\n\t\t{\n\t\t\tint _counter_1 = counter;\n\t\t\t<%org.eclipse.emf.common.util.EList%><<%ch.hilbri.assist.datamodel.model.EqInterface%>> _eqInterfaces = ((<%ch.hilbri.assist.datamodel.model.EqInterfaceGroup%>)e).getEqInterfaces();\n\t\t\tint _length = ((<%java.lang.Object%>[])org.eclipse.xtext.xbase.lib.Conversions.unwrapArray(_eqInterfaces, <%java.lang.Object%>.class)).length;\n\t\t\tcounter = (_counter_1 + _length);\n\t\t}\n\t}\n}\nreturn counter;'"
	 * @generated
	 */
	int getTotalInterfaceCount();
