...
public class ModelPackageImpl extends EPackageImpl implements ModelPackage {
	...
	public void initializePackageContents() {
		...
		initEClass(threadEClass, ch.hilbri.assist.datamodel.model.Thread.class, "Thread", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getThread_Name(), theEcorePackage.getEString(), "name", null, 0, 1, ch.hilbri.assist.datamodel.model.Thread.class, IS_TRANSIENT, IS_VOLATILE, !IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEAttribute(getThread_CoreUtilization(), theEcorePackage.getEInt(), "coreUtilization", null, 0, 1, ch.hilbri.assist.datamodel.model.Thread.class, IS_TRANSIENT, IS_VOLATILE, !IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEReference(getThread_Application(), this.getApplication(), this.getApplication_Threads(), "application", null, 0, 1, ch.hilbri.assist.datamodel.model.Thread.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getThread_Duration(), theEcorePackage.getEInt(), "duration", "0", 0, 1, ch.hilbri.assist.datamodel.model.Thread.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getThread_Period(), theEcorePackage.getEInt(), "period", "0", 0, 1, ch.hilbri.assist.datamodel.model.Thread.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getThread_EarlyTolerance(), theEcorePackage.getEInt(), "earlyTolerance", "0", 0, 1, ch.hilbri.assist.datamodel.model.Thread.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getThread_LateTolerance(), theEcorePackage.getEInt(), "lateTolerance", "0", 0, 1, ch.hilbri.assist.datamodel.model.Thread.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getThread_LatestStartTime(), theEcorePackage.getEInt(), "latestStartTime", "0", 0, 1, ch.hilbri.assist.datamodel.model.Thread.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getThread_LatestEndTime(), theEcorePackage.getEInt(), "latestEndTime", "0", 0, 1, ch.hilbri.assist.datamodel.model.Thread.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getThread_InitTime(), theEcorePackage.getEInt(), "initTime", "0", 0, 1, ch.hilbri.assist.datamodel.model.Thread.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getThread_MaxSlices(), theEcorePackage.getEInt(), "maxSlices", "0", 0, 1, ch.hilbri.assist.datamodel.model.Thread.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getThread_MinSliceDuration(), theEcorePackage.getEInt(), "minSliceDuration", "0", 0, 1, ch.hilbri.assist.datamodel.model.Thread.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getThread_Location(), this.getCore(), null, "location", null, 0, 1, ch.hilbri.assist.datamodel.model.Thread.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
