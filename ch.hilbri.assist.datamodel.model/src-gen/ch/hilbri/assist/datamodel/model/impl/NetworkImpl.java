 ...
 * </p>
 * <ul>
 *   <li>{@link ch.hilbri.assist.datamodel.model.impl.NetworkImpl#getName <em>Name</em>}</li>
 *   <li>{@link ch.hilbri.assist.datamodel.model.impl.NetworkImpl#getBandwidthCapacity <em>Bandwidth Capacity</em>}</li>
 *   <li>{@link ch.hilbri.assist.datamodel.model.impl.NetworkImpl#getBoards <em>Boards</em>}</li>
 *   <li>{@link ch.hilbri.assist.datamodel.model.impl.NetworkImpl#getMetricParameters <em>Metric Parameters</em>}</li>
 *   <li>{@link ch.hilbri.assist.datamodel.model.impl.NetworkImpl#isIsBoardLocal <em>Is Board Local</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NetworkImpl extends MinimalEObjectImpl.Container implements Network {
	...
	/**
	 * The default value of the '{@link #isIsBoardLocal() <em>Is Board Local</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isIsBoardLocal()
	 * @generated
	 * @ordered
	 */
	protected static final boolean IS_BOARD_LOCAL_EDEFAULT = false;
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case ModelPackage.NETWORK__IS_BOARD_LOCAL:
				return isIsBoardLocal() != IS_BOARD_LOCAL_EDEFAULT;
		}
