...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Cable Weight Data</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link ch.hilbri.assist.datamodel.model.impl.CableWeightDataImpl#getCableWeightEntries <em>Cable Weight Entries</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CableWeightDataImpl extends MinimalEObjectImpl.Container implements CableWeightData {
	/**
	...
	protected EClass eStaticClass() {
		return ModelPackage.Literals.CABLE_WEIGHT_DATA;
	}
	...
	public EList<CableWeightEntry> getCableWeightEntries() {
		if (cableWeightEntries == null) {
			cableWeightEntries = new EObjectContainmentEList<CableWeightEntry>(CableWeightEntry.class, this, ModelPackage.CABLE_WEIGHT_DATA__CABLE_WEIGHT_ENTRIES);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModelPackage.CABLE_WEIGHT_DATA__CABLE_WEIGHT_ENTRIES:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case ModelPackage.CABLE_WEIGHT_DATA___GET_DEFAULT_CABLE_WEIGHT:
				return getDefaultCableWeight();
			case ModelPackage.CABLE_WEIGHT_DATA___GET_CABLE_WEIGHT__STRING:
