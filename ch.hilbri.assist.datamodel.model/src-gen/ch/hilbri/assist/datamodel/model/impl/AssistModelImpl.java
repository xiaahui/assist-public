 ...
 *   <li>{@link ch.hilbri.assist.datamodel.model.impl.AssistModelImpl#getChangeDelay <em>Change Delay</em>}</li>
 *   <li>{@link ch.hilbri.assist.datamodel.model.impl.AssistModelImpl#getHardwareContainer <em>Hardware Container</em>}</li>
 *   <li>{@link ch.hilbri.assist.datamodel.model.impl.AssistModelImpl#getNetworks <em>Networks</em>}</li>
 *   <li>{@link ch.hilbri.assist.datamodel.model.impl.AssistModelImpl#getApplications <em>Applications</em>}</li>
 *   <li>{@link ch.hilbri.assist.datamodel.model.impl.AssistModelImpl#getApplicationGroups <em>Application Groups</em>}</li>
 *   <li>{@link ch.hilbri.assist.datamodel.model.impl.AssistModelImpl#getDissimilarityRelations <em>Dissimilarity Relations</em>}</li>
 *   <li>{@link ch.hilbri.assist.datamodel.model.impl.AssistModelImpl#getDislocalityRelations <em>Dislocality Relations</em>}</li>
 *   <li>{@link ch.hilbri.assist.datamodel.model.impl.AssistModelImpl#getProximityRelations <em>Proximity Relations</em>}</li>
 *   <li>{@link ch.hilbri.assist.datamodel.model.impl.AssistModelImpl#getCommunicationRelations <em>Communication Relations</em>}</li>
 *   <li>{@link ch.hilbri.assist.datamodel.model.impl.AssistModelImpl#getSchedulingRelations <em>Scheduling Relations</em>}</li>
 *   <li>{@link ch.hilbri.assist.datamodel.model.impl.AssistModelImpl#getTopHardwareLevel <em>Top Hardware Level</em>}</li>
 *   <li>{@link ch.hilbri.assist.datamodel.model.impl.AssistModelImpl#getBottomHardwareLevel <em>Bottom Hardware Level</em>}</li>
 *   <li>{@link ch.hilbri.assist.datamodel.model.impl.AssistModelImpl#getHardwareLevelCount <em>Hardware Level Count</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AssistModelImpl extends MinimalEObjectImpl.Container implements AssistModel {
	 ...
	 * @generated
	 */
	public EList<ch.hilbri.assist.datamodel.model.Thread> getAllThreads() {
		final BasicEList<ch.hilbri.assist.datamodel.model.Thread> list = new BasicEList<ch.hilbri.assist.datamodel.model.Thread>();
