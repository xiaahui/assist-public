...
public class ModelSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ModelPackage.THREAD: {
				ch.hilbri.assist.datamodel.model.Thread thread = (ch.hilbri.assist.datamodel.model.Thread)theEObject;
	 ...
	 * @generated
	 */
	public T caseThread(ch.hilbri.assist.datamodel.model.Thread object) {
		return null;
	}
