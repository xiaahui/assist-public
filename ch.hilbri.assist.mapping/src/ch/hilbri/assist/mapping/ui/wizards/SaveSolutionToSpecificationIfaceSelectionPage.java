...
public class SaveSolutionToSpecificationIfaceSelectionPage extends WizardPage {
	...
	protected SaveSolutionToSpecificationIfaceSelectionPage(Map<EqInterface, Connector> mapping) {
		super("InterfaceSelection");
		setTitle("Select Interface Mappings");
		setDescription("Please select the mappings from the currently selected solution");
