...
class SaveSolutionToSpecificationWizard extends Wizard implements INewWizard  {

    private IStructuredSelection selection
    
    private WizardNewFileCreationPage fileSelectionPage
    private SaveSolutionToSpecificationIfaceSelectionPage interfaceSelectionPage
	...
	new(String filenameSuggestion, Map<EqInterface, Connector> mapping, AssistModel model) {
		super()
		setWindowTitle("Save Generated Mappings to Specification")
	...
	override void addPages() {
		...
		interfaceSelectionPage = new SaveSolutionToSpecificationIfaceSelectionPage(mapping)
		
		addPage(interfaceSelectionPage)
		
		fileSelectionPage = new WizardNewFileCreationPage("NewFileSelectionPage", selection)
		fileSelectionPage.setTitle("Title")
		fileSelectionPage.setDescription("Description")
		fileSelectionPage.setFileName(filenameSuggestion)
		fileSelectionPage.setFileExtension("mdsl")
