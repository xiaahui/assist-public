...
public class ResultsViewController extends AnchorPane{
	...
	private void drawTreeView(int index) {
		...
		for (Compartment compartment : r.getAllCompartments())
...
//			TreeItem<TreeObject> unmappedThreads = new TreeItem<TreeObject>(new TreeObject("Unmapped threads"), jv);
//			systemNode.getChildren().add(unmappedThreads);
//			unmappedThreads.setExpanded(true);
