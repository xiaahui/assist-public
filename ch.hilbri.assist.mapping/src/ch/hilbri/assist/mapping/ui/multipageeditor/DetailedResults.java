...
public class DetailedResults extends Composite {
    ...
    private TabItem tabTabularView;
    private TabItem tabTopologyView;
    private Composite compositeTabularView;
    private Composite compositeTopologyView;
    ...
    public DetailedResults(MultiPageEditor e, Composite parent, int style) {
        ...
        lblSolutionName.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true, false, 1, 1));
        ...
        tabTabularView = new TabItem(tabFolder, SWT.NONE);
        tabTabularView.setText("Tabular View");

        compositeTabularView = new Composite(tabFolder, SWT.NONE);
        tabTabularView.setControl(compositeTabularView);
        ...
        textFilter = new Text(compositeTabularView, SWT.BORDER | SWT.SEARCH | SWT.ICON_SEARCH);
        ...
        tabTopologyView = new TabItem(tabFolder, SWT.NONE);
        tabTopologyView.setText("Topology View");

        compositeTopologyView = new Composite(tabFolder, SWT.NONE);
        tabTopologyView.setControl(compositeTopologyView);
        ...
        GridData gd_compositeScoreOverview = new GridData(SWT.FILL, SWT.BOTTOM, true, false, 1, 1);
