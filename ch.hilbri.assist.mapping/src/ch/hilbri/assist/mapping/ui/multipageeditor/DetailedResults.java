...
public class DetailedResults extends Composite {
	...
	private CTabFolder tabViews;
	private CTabItem tbtmTabularView;
	private CTabItem tbtmTopologyview;
	...
	public DetailedResults(MultiPageEditor e, Composite parent, int style) {
		...
		compositeTabularView = new Composite(tabViews, SWT.NONE);
		...
		tbtmTopologyview = new CTabItem(tabViews, SWT.NONE);
		tbtmTopologyview.setText("Topology View");

		compositeTopologyView = new Composite(tabViews, SWT.NONE);
