...
import ch.hilbri.assist.mapping.solver.exceptions.applicationproximity.TwoApplicationsCouldNotBeDeployedToTheSameHardwareElement;
...
public class ApplicationProximityConstraint extends AbstractMappingConstraint {
          ...
          for (int i = 0; (i < (threadVarList.size() - 1)); i++) {
            {
              ...
              ch.hilbri.assist.datamodel.model.Thread _get_2 = threadList.get(i);
              Application _application = _get_2.getApplication();
              ch.hilbri.assist.datamodel.model.Thread _get_3 = threadList.get((i + 1));
              Application _application_1 = _get_3.getApplication();
              this.propagate(_application, _application_1, level);
            }
          }
        }
      }
  ...
  public void propagate(final Application a1, final Application a2, final HardwareArchitectureLevelType level) {
    try {
      try {
