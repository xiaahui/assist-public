...
public class ResultPackageImpl extends EPackageImpl implements ResultPackage {
	...
	public EReference getIOAdapter_ReferenceObject() {
		return (EReference)ioAdapterEClass.getEStructuralFeatures().get(3);
	}
	...
	public void initializePackageContents() {
		...
		initEDataType(metricScoreMapEDataType, HashMap.class, "MetricScoreMap", IS_SERIALIZABLE, !IS_GENERATED_INSTANCE_CLASS, "java.util.HashMap<ch.hilbri.assist.mapping.model.result.AbstractMetric, java.lang.Double>");
