 ...
 * </p>
 * <ul>
 *   <li>{@link ch.hilbri.assist.mapping.model.result.impl.CompartmentImpl#getManufacturer <em>Manufacturer</em>}</li>
 *   <li>{@link ch.hilbri.assist.mapping.model.result.impl.CompartmentImpl#getPowerSupply <em>Power Supply</em>}</li>
 *   <li>{@link ch.hilbri.assist.mapping.model.result.impl.CompartmentImpl#getSide <em>Side</em>}</li>
 *   <li>{@link ch.hilbri.assist.mapping.model.result.impl.CompartmentImpl#getZone <em>Zone</em>}</li>
 *   <li>{@link ch.hilbri.assist.mapping.model.result.impl.CompartmentImpl#getBoxes <em>Boxes</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CompartmentImpl extends HardwareElementImpl implements Compartment {
	...
	protected EClass eStaticClass() {
		return ResultPackage.Literals.COMPARTMENT;
	}
	...
	public void setManufacturer(String newManufacturer) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResultPackage.COMPARTMENT__MANUFACTURER, oldManufacturer, manufacturer));
	}
	...
	public void setPowerSupply(String newPowerSupply) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResultPackage.COMPARTMENT__POWER_SUPPLY, oldPowerSupply, powerSupply));
	}
	...
	public void setSide(String newSide) {
		...
		side = newSide;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResultPackage.COMPARTMENT__SIDE, oldSide, side));
	}
	...
	public void setZone(String newZone) {
		...
		zone = newZone;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResultPackage.COMPARTMENT__ZONE, oldZone, zone));
	}
	...
	public EList<Box> getBoxes() {
		if (boxes == null) {
			boxes = new EObjectContainmentWithInverseEList<Box>(Box.class, this, ResultPackage.COMPARTMENT__BOXES, ResultPackage.BOX__COMPARTMENT);
		}
		return boxes;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ResultPackage.COMPARTMENT__BOXES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ResultPackage.COMPARTMENT__MANUFACTURER:
				return getManufacturer();
			case ResultPackage.COMPARTMENT__POWER_SUPPLY:
				return getPowerSupply();
			case ResultPackage.COMPARTMENT__SIDE:
				return getSide();
			case ResultPackage.COMPARTMENT__ZONE:
				return getZone();
			case ResultPackage.COMPARTMENT__BOXES:
				return getBoxes();
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case ResultPackage.COMPARTMENT___GET_ALL_BOARDS:
				return getAllBoards();
			case ResultPackage.COMPARTMENT___GET_ALL_PROCESSORS:
				return getAllProcessors();
			case ResultPackage.COMPARTMENT___GET_ALL_CORES:
				return getAllCores();
			case ResultPackage.COMPARTMENT___GET_HARDWARE_LEVEL:
