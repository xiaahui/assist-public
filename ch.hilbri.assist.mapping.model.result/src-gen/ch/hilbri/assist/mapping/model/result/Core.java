 ...
 * </p>
 * <ul>
 *   <li>{@link ch.hilbri.assist.mapping.model.result.Core#getArchitecture <em>Architecture</em>}</li>
 *   <li>{@link ch.hilbri.assist.mapping.model.result.Core#getCapacity <em>Capacity</em>}</li>
 *   <li>{@link ch.hilbri.assist.mapping.model.result.Core#getUtilization <em>Utilization</em>}</li>
 *   <li>{@link ch.hilbri.assist.mapping.model.result.Core#getRelativeUtilization <em>Relative Utilization</em>}</li>
 *   <li>{@link ch.hilbri.assist.mapping.model.result.Core#getProcessor <em>Processor</em>}</li>
 *   <li>{@link ch.hilbri.assist.mapping.model.result.Core#getThreads <em>Threads</em>}</li>
 *   <li>{@link ch.hilbri.assist.mapping.model.result.Core#isNotUsed <em>Not Used</em>}</li>
 *   <li>{@link ch.hilbri.assist.mapping.model.result.Core#getRemainingAbsoluteCapacity <em>Remaining Absolute Capacity</em>}</li>
 *   <li>{@link ch.hilbri.assist.mapping.model.result.Core#getRemainingRelativeCapacity <em>Remaining Relative Capacity</em>}</li>
 * </ul>
 *
 * @see ch.hilbri.assist.mapping.model.result.ResultPackage#getCore()
 * @model
 * @generated
 */
public interface Core extends HardwareElement {
	 ...
	 * @see ch.hilbri.assist.mapping.model.result.ResultPackage#getCore_Architecture()
	 * @model unique="false"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link ch.hilbri.assist.mapping.model.result.Core#getArchitecture <em>Architecture</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setCapacity(int)
	 * @see ch.hilbri.assist.mapping.model.result.ResultPackage#getCore_Capacity()
	 * @model unique="false"
	 * @generated
	 */
	int getCapacity();
	...
	/**
	 * Sets the value of the '{@link ch.hilbri.assist.mapping.model.result.Core#getCapacity <em>Capacity</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ch.hilbri.assist.mapping.model.result.ResultPackage#getCore_Utilization()
	 * @model unique="false"
	 * @generated
	 */
	int getUtilization();
	...
	/**
	 * Sets the value of the '{@link ch.hilbri.assist.mapping.model.result.Core#getUtilization <em>Utilization</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ch.hilbri.assist.mapping.model.result.ResultPackage#getCore_RelativeUtilization()
	 ...
	 * It is bidirectional and its opposite is '{@link ch.hilbri.assist.mapping.model.result.Processor#getCores <em>Cores</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see ch.hilbri.assist.mapping.model.result.ResultPackage#getCore_Processor()
	...
	/**
	 * Sets the value of the '{@link ch.hilbri.assist.mapping.model.result.Core#getProcessor <em>Processor</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ch.hilbri.assist.mapping.model.result.ResultPackage#getCore_Threads()
	 * @model
	 * @generated
	 */
	 ...
	 * @see ch.hilbri.assist.mapping.model.result.ResultPackage#getCore_NotUsed()
	 * @model unique="false" transient="true" changeable="false" volatile="true" derived="true"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel get='<%org.eclipse.emf.common.util.EList%><<%ch.hilbri.assist.mapping.model.result.Thread%>> _threads = this.getThreads();\nreturn _threads.isEmpty();'"
	 * @generated
	 */
	boolean isNotUsed();
	 ...
	 * @see ch.hilbri.assist.mapping.model.result.ResultPackage#getCore_RemainingAbsoluteCapacity()
	 * @model unique="false" transient="true" changeable="false" volatile="true" derived="true"
	 ...
	 * @see ch.hilbri.assist.mapping.model.result.ResultPackage#getCore_RemainingRelativeCapacity()
	 * @model unique="false" transient="true" changeable="false" volatile="true" derived="true"
