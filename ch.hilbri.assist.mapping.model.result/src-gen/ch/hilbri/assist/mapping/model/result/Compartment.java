 ...
 * </p>
 * <ul>
 *   <li>{@link ch.hilbri.assist.mapping.model.result.Compartment#getManufacturer <em>Manufacturer</em>}</li>
 *   <li>{@link ch.hilbri.assist.mapping.model.result.Compartment#getPowerSupply <em>Power Supply</em>}</li>
 *   <li>{@link ch.hilbri.assist.mapping.model.result.Compartment#getSide <em>Side</em>}</li>
 *   <li>{@link ch.hilbri.assist.mapping.model.result.Compartment#getZone <em>Zone</em>}</li>
 *   <li>{@link ch.hilbri.assist.mapping.model.result.Compartment#getBoxes <em>Boxes</em>}</li>
 * </ul>
 *
 * @see ch.hilbri.assist.mapping.model.result.ResultPackage#getCompartment()
 * @model
 * @generated
 */
public interface Compartment extends HardwareElement {
	 ...
	 * @see ch.hilbri.assist.mapping.model.result.ResultPackage#getCompartment_Manufacturer()
	 * @model unique="false"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link ch.hilbri.assist.mapping.model.result.Compartment#getManufacturer <em>Manufacturer</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ch.hilbri.assist.mapping.model.result.ResultPackage#getCompartment_PowerSupply()
	 * @model unique="false"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link ch.hilbri.assist.mapping.model.result.Compartment#getPowerSupply <em>Power Supply</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setSide(String)
	 * @see ch.hilbri.assist.mapping.model.result.ResultPackage#getCompartment_Side()
	 * @model unique="false"
	 * @generated
	 */
	String getSide();
	...
	/**
	 * Sets the value of the '{@link ch.hilbri.assist.mapping.model.result.Compartment#getSide <em>Side</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setZone(String)
	 * @see ch.hilbri.assist.mapping.model.result.ResultPackage#getCompartment_Zone()
	 * @model unique="false"
	 * @generated
	 */
	String getZone();
	...
	/**
	 * Sets the value of the '{@link ch.hilbri.assist.mapping.model.result.Compartment#getZone <em>Zone</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link ch.hilbri.assist.mapping.model.result.Box}.
	 * It is bidirectional and its opposite is '{@link ch.hilbri.assist.mapping.model.result.Box#getCompartment <em>Compartment</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see ch.hilbri.assist.mapping.model.result.ResultPackage#getCompartment_Boxes()
	 ...
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='final <%org.eclipse.emf.common.util.BasicEList%><<%ch.hilbri.assist.mapping.model.result.Board%>> list = new <%org.eclipse.emf.common.util.BasicEList%><<%ch.hilbri.assist.mapping.model.result.Board%>>();\n<%org.eclipse.emf.common.util.EList%><<%ch.hilbri.assist.mapping.model.result.Box%>> _boxes = this.getBoxes();\nfor (final <%ch.hilbri.assist.mapping.model.result.Box%> b : _boxes)\n{\n\t<%org.eclipse.emf.common.util.EList%><<%ch.hilbri.assist.mapping.model.result.Board%>> _boards = b.getBoards();\n\tlist.addAll(_boards);\n}\nreturn list;'"
	 * @generated
	 */
