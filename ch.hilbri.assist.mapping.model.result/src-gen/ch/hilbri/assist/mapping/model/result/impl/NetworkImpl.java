 ...
 * </p>
 * <ul>
 *   <li>{@link ch.hilbri.assist.mapping.model.result.impl.NetworkImpl#getName <em>Name</em>}</li>
 *   <li>{@link ch.hilbri.assist.mapping.model.result.impl.NetworkImpl#getBandwidthCapacity <em>Bandwidth Capacity</em>}</li>
 *   <li>{@link ch.hilbri.assist.mapping.model.result.impl.NetworkImpl#isIsBoardLocalNetwork <em>Is Board Local Network</em>}</li>
 *   <li>{@link ch.hilbri.assist.mapping.model.result.impl.NetworkImpl#getBoards <em>Boards</em>}</li>
 *   <li>{@link ch.hilbri.assist.mapping.model.result.impl.NetworkImpl#getReferenceObject <em>Reference Object</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NetworkImpl extends MinimalEObjectImpl.Container implements Network {
	 ...
	 * @ordered
	 */
	protected ch.hilbri.assist.mapping.model.Network referenceObject;
	 ...
	 * @generated
	 */
	public ch.hilbri.assist.mapping.model.Network getReferenceObject() {
		if (referenceObject != null && referenceObject.eIsProxy()) {
			InternalEObject oldReferenceObject = (InternalEObject)referenceObject;
			referenceObject = (ch.hilbri.assist.mapping.model.Network)eResolveProxy(oldReferenceObject);
			if (referenceObject != oldReferenceObject) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResultPackage.NETWORK__REFERENCE_OBJECT, oldReferenceObject, referenceObject));
			}
		}
	 ...
	 * @generated
	 */
	public ch.hilbri.assist.mapping.model.Network basicGetReferenceObject() {
		return referenceObject;
	}
	 ...
	 * @generated
	 */
	public void setReferenceObject(ch.hilbri.assist.mapping.model.Network newReferenceObject) {
		ch.hilbri.assist.mapping.model.Network oldReferenceObject = referenceObject;
		referenceObject = newReferenceObject;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResultPackage.NETWORK__REFERENCE_OBJECT, oldReferenceObject, referenceObject));
	}
	...
	public int getMetricParameterValue(final String parameterName) {
		ch.hilbri.assist.mapping.model.Network _referenceObject = this.getReferenceObject();
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ResultPackage.NETWORK__BOARDS:
				return getBoards();
			case ResultPackage.NETWORK__REFERENCE_OBJECT:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case ResultPackage.NETWORK__BOARDS:
				...
				return;
			case ResultPackage.NETWORK__REFERENCE_OBJECT:
				setReferenceObject((ch.hilbri.assist.mapping.model.Network)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case ResultPackage.NETWORK__BOARDS:
				...
				return;
			case ResultPackage.NETWORK__REFERENCE_OBJECT:
				setReferenceObject((ch.hilbri.assist.mapping.model.Network)null);
				return;
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case ResultPackage.NETWORK___GET_METRIC_PARAMETER_VALUE__STRING:
