...
public class MappingSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case MappingPackage.THREAD: {
				ch.hilbri.assist.datamodel.result.mapping.Thread thread = (ch.hilbri.assist.datamodel.result.mapping.Thread)theEObject;
			...
			case MappingPackage.METRIC_PARAMETER: {
	 ...
	 * @generated
	 */
	public T caseThread(ch.hilbri.assist.datamodel.result.mapping.Thread object) {
		return null;
	}
