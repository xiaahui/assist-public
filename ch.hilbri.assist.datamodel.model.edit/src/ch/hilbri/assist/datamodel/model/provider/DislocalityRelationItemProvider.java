...
/**
 * This is the item provider adapter for a {@link ch.hilbri.assist.datamodel.model.DislocalityRelation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DislocalityRelationItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DislocalityRelation_applicationsOrGroups_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DislocalityRelation_applicationsOrGroups_feature", "_UI_DislocalityRelation_type"),
				 ModelPackage.Literals.DISLOCALITY_RELATION__APPLICATIONS_OR_GROUPS,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addHardwareLevelPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DislocalityRelation_hardwareLevel_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DislocalityRelation_hardwareLevel_feature", "_UI_DislocalityRelation_type"),
				 ModelPackage.Literals.DISLOCALITY_RELATION__HARDWARE_LEVEL,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(DislocalityRelation.class)) {
