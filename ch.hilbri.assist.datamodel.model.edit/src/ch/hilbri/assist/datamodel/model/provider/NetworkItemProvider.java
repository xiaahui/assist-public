...
/**
 * This is the item provider adapter for a {@link ch.hilbri.assist.datamodel.model.Network} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NetworkItemProvider 
	...
	/**
	 * This adds a property descriptor for the Bandwidth Capacity feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addBandwidthCapacityPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Network_bandwidthCapacity_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Network_bandwidthCapacity_feature", "_UI_Network_type"),
				 ModelPackage.Literals.NETWORK__BANDWIDTH_CAPACITY,
				 true,
				 false,
				 false,
	 ...
	 * @generated
	 */
	protected void addBoardsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Network_boards_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Network_boards_feature", "_UI_Network_type"),
				 ModelPackage.Literals.NETWORK__BOARDS,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ModelPackage.Literals.NETWORK__METRIC_PARAMETERS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ModelPackage.Literals.NETWORK__METRIC_PARAMETERS,
