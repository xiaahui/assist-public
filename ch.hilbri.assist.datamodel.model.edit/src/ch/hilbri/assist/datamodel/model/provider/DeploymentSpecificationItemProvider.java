...
/**
 * This is the item provider adapter for a {@link ch.hilbri.assist.datamodel.model.DeploymentSpecification} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DeploymentSpecificationItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DeploymentSpecification_eqInterfaceOrGroups_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DeploymentSpecification_eqInterfaceOrGroups_feature", "_UI_DeploymentSpecification_type"),
				 ModelPackage.Literals.DEPLOYMENT_SPECIFICATION__EQ_INTERFACE_OR_GROUPS,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addHardwareElementsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DeploymentSpecification_hardwareElements_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DeploymentSpecification_hardwareElements_feature", "_UI_DeploymentSpecification_type"),
				 ModelPackage.Literals.DEPLOYMENT_SPECIFICATION__HARDWARE_ELEMENTS,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ModelPackage.Literals.DEPLOYMENT_SPECIFICATION__IMPLICIT_HARDWARE_ELEMENTS);
		}
	...
	public String getText(Object object) {
		return getString("_UI_DeploymentSpecification_type");
	}
		...
		newChildDescriptors.add
			(createChildParameter
				(ModelPackage.Literals.DEPLOYMENT_SPECIFICATION__IMPLICIT_HARDWARE_ELEMENTS,
				 ModelFactory.eINSTANCE.createDeploymentImplicitDefinition()));
	}
