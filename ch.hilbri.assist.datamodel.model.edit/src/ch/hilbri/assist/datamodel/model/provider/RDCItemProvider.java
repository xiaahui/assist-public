...
public class RDCItemProvider extends HardwareElementItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ModelPackage.Literals.RDC__INTERNAL_CONNECTED_PIN_BLOCK);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ModelPackage.Literals.RDC__INTERNAL_CONNECTED_PIN_BLOCK,
				 ModelFactory.eINSTANCE.createInternalConnectedPinBlock()));
	}
