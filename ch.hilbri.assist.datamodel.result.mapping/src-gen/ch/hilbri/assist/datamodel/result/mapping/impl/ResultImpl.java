...
public class ResultImpl extends MinimalEObjectImpl.Container implements Result {
	 ...
	 * @generated
	 */
	public Application findResultApplication(final ch.hilbri.assist.datamodel.model.Application modelApp) {
		EList<Application> _applications = this.getApplications();
	 ...
	 * @generated
	 */
	public ch.hilbri.assist.datamodel.result.mapping.Thread findResultThread(final ch.hilbri.assist.datamodel.model.Thread modelThread) {
	 ...
	 * @generated
	 */
	public ApplicationGroup findResultApplicationGroup(final ch.hilbri.assist.datamodel.model.ApplicationGroup modelAppGroup) {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case MappingPackage.RESULT___FIND_RESULT_HARDWARE_ELEMENT__HARDWAREELEMENT:
				return findResultHardwareElement((ch.hilbri.assist.datamodel.model.HardwareElement)arguments.get(0));
			case MappingPackage.RESULT___FIND_RESULT_APPLICATION__APPLICATION:
				return findResultApplication((ch.hilbri.assist.datamodel.model.Application)arguments.get(0));
			case MappingPackage.RESULT___FIND_RESULT_THREAD__THREAD:
				return findResultThread((ch.hilbri.assist.datamodel.model.Thread)arguments.get(0));
			case MappingPackage.RESULT___FIND_RESULT_APPLICATION_GROUP__APPLICATIONGROUP:
				return findResultApplicationGroup((ch.hilbri.assist.datamodel.model.ApplicationGroup)arguments.get(0));
		}
