 ...
 * </p>
 * <ul>
 *   <li>{@link ch.hilbri.assist.datamodel.result.mapping.impl.ApplicationGroupImpl#getName <em>Name</em>}</li>
 *   <li>{@link ch.hilbri.assist.datamodel.result.mapping.impl.ApplicationGroupImpl#getApplications <em>Applications</em>}</li>
 *   <li>{@link ch.hilbri.assist.datamodel.result.mapping.impl.ApplicationGroupImpl#getApplicationGroups <em>Application Groups</em>}</li>
 *   <li>{@link ch.hilbri.assist.datamodel.result.mapping.impl.ApplicationGroupImpl#getReferenceObject <em>Reference Object</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ApplicationGroupImpl extends MinimalEObjectImpl.Container implements ApplicationGroup {
	 ...
	 * @ordered
	 */
	protected ch.hilbri.assist.datamodel.model.ApplicationGroup referenceObject;
	 ...
	 * @generated
	 */
	public ch.hilbri.assist.datamodel.model.ApplicationGroup getReferenceObject() {
		if (referenceObject != null && referenceObject.eIsProxy()) {
			InternalEObject oldReferenceObject = (InternalEObject)referenceObject;
			referenceObject = (ch.hilbri.assist.datamodel.model.ApplicationGroup)eResolveProxy(oldReferenceObject);
	 ...
	 * @generated
	 */
	public ch.hilbri.assist.datamodel.model.ApplicationGroup basicGetReferenceObject() {
		return referenceObject;
	}
	 ...
	 * @generated
	 */
	public void setReferenceObject(ch.hilbri.assist.datamodel.model.ApplicationGroup newReferenceObject) {
		ch.hilbri.assist.datamodel.model.ApplicationGroup oldReferenceObject = referenceObject;
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case MappingPackage.APPLICATION_GROUP__APPLICATION_GROUPS:
				...
				return;
			case MappingPackage.APPLICATION_GROUP__REFERENCE_OBJECT:
				setReferenceObject((ch.hilbri.assist.datamodel.model.ApplicationGroup)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case MappingPackage.APPLICATION_GROUP__APPLICATION_GROUPS:
				...
				return;
			case MappingPackage.APPLICATION_GROUP__REFERENCE_OBJECT:
				setReferenceObject((ch.hilbri.assist.datamodel.model.ApplicationGroup)null);
				return;
		}
