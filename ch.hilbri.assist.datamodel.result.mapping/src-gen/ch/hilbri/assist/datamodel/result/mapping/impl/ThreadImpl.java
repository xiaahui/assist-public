 ...
 * <ul>
 *   <li>{@link ch.hilbri.assist.datamodel.result.mapping.impl.ThreadImpl#getApplication <em>Application</em>}</li>
 *   <li>{@link ch.hilbri.assist.datamodel.result.mapping.impl.ThreadImpl#getCore <em>Core</em>}</li>
 *   <li>{@link ch.hilbri.assist.datamodel.result.mapping.impl.ThreadImpl#getReferenceObject <em>Reference Object</em>}</li>
 *   <li>{@link ch.hilbri.assist.datamodel.result.mapping.impl.ThreadImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ThreadImpl extends MinimalEObjectImpl.Container implements ch.hilbri.assist.datamodel.result.mapping.Thread {
	/**
	 ...
	 * @ordered
	 */
	protected ch.hilbri.assist.datamodel.model.Thread referenceObject;
	...
	protected EClass eStaticClass() {
		return MappingPackage.Literals.THREAD;
	}
	...
	public Application getApplication() {
		if (eContainerFeatureID() != MappingPackage.THREAD__APPLICATION) return null;
	...
	public NotificationChain basicSetApplication(Application newApplication, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newApplication, MappingPackage.THREAD__APPLICATION, msgs);
		return msgs;
	}
	...
	public void setApplication(Application newApplication) {
		if (newApplication != eInternalContainer() || (eContainerFeatureID() != MappingPackage.THREAD__APPLICATION && newApplication != null)) {
			...
			if (newApplication != null)
				msgs = ((InternalEObject)newApplication).eInverseAdd(this, MappingPackage.APPLICATION__THREADS, Application.class, msgs);
			msgs = basicSetApplication(newApplication, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MappingPackage.THREAD__APPLICATION, newApplication, newApplication));
	}
	 ...
	 * @generated
	 */
	public ch.hilbri.assist.datamodel.model.Thread getReferenceObject() {
		if (referenceObject != null && referenceObject.eIsProxy()) {
			InternalEObject oldReferenceObject = (InternalEObject)referenceObject;
			referenceObject = (ch.hilbri.assist.datamodel.model.Thread)eResolveProxy(oldReferenceObject);
	 ...
	 * @generated
	 */
	public ch.hilbri.assist.datamodel.model.Thread basicGetReferenceObject() {
		return referenceObject;
	}
	 ...
	 * @generated
	 */
	public void setReferenceObject(ch.hilbri.assist.datamodel.model.Thread newReferenceObject) {
		ch.hilbri.assist.datamodel.model.Thread oldReferenceObject = referenceObject;
	...
	public String getName() {
		...
		EList<ch.hilbri.assist.datamodel.result.mapping.Thread> _threads = _application_1.getThreads();
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case MappingPackage.THREAD__APPLICATION:
				return eInternalContainer().eInverseRemove(this, MappingPackage.APPLICATION__THREADS, Application.class, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case MappingPackage.THREAD__CORE:
				...
				return;
			case MappingPackage.THREAD__REFERENCE_OBJECT:
				setReferenceObject((ch.hilbri.assist.datamodel.model.Thread)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case MappingPackage.THREAD__CORE:
				...
				return;
			case MappingPackage.THREAD__REFERENCE_OBJECT:
				setReferenceObject((ch.hilbri.assist.datamodel.model.Thread)null);
				return;
		}
