 ...
 * </p>
 * <ul>
 *   <li>{@link ch.hilbri.assist.datamodel.result.mapping.impl.IOAdapterImpl#getName <em>Name</em>}</li>
 *   <li>{@link ch.hilbri.assist.datamodel.result.mapping.impl.IOAdapterImpl#getTotalUnitCount <em>Total Unit Count</em>}</li>
 *   <li>{@link ch.hilbri.assist.datamodel.result.mapping.impl.IOAdapterImpl#getAdapterType <em>Adapter Type</em>}</li>
 *   <li>{@link ch.hilbri.assist.datamodel.result.mapping.impl.IOAdapterImpl#getProtectionLevel <em>Protection Level</em>}</li>
 *   <li>{@link ch.hilbri.assist.datamodel.result.mapping.impl.IOAdapterImpl#getReferenceObject <em>Reference Object</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IOAdapterImpl extends MinimalEObjectImpl.Container implements IOAdapter {
	 ...
	 * @ordered
	 */
	protected ch.hilbri.assist.datamodel.model.IOAdapter referenceObject;
	...
	protected EClass eStaticClass() {
		return MappingPackage.Literals.IO_ADAPTER;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MappingPackage.IO_ADAPTER__NAME, oldName, name));
	}
	...
	public void setTotalUnitCount(int newTotalUnitCount) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MappingPackage.IO_ADAPTER__TOTAL_UNIT_COUNT, oldTotalUnitCount, totalUnitCount));
	}
	...
	public void setAdapterType(IOAdapterType newAdapterType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MappingPackage.IO_ADAPTER__ADAPTER_TYPE, oldAdapterType, adapterType));
	}
	...
	public void setProtectionLevel(IOAdapterProtectionLevelType newProtectionLevel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MappingPackage.IO_ADAPTER__PROTECTION_LEVEL, oldProtectionLevel, protectionLevel));
	}
	 ...
	 * @generated
	 */
	public ch.hilbri.assist.datamodel.model.IOAdapter getReferenceObject() {
		if (referenceObject != null && referenceObject.eIsProxy()) {
			InternalEObject oldReferenceObject = (InternalEObject)referenceObject;
			referenceObject = (ch.hilbri.assist.datamodel.model.IOAdapter)eResolveProxy(oldReferenceObject);
	 ...
	 * @generated
	 */
	public ch.hilbri.assist.datamodel.model.IOAdapter basicGetReferenceObject() {
		return referenceObject;
	}
	 ...
	 * @generated
	 */
	public void setReferenceObject(ch.hilbri.assist.datamodel.model.IOAdapter newReferenceObject) {
		ch.hilbri.assist.datamodel.model.IOAdapter oldReferenceObject = referenceObject;
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MappingPackage.IO_ADAPTER__NAME:
				return getName();
			case MappingPackage.IO_ADAPTER__TOTAL_UNIT_COUNT:
				return getTotalUnitCount();
			case MappingPackage.IO_ADAPTER__ADAPTER_TYPE:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case MappingPackage.IO_ADAPTER__PROTECTION_LEVEL:
				...
				return;
			case MappingPackage.IO_ADAPTER__REFERENCE_OBJECT:
				setReferenceObject((ch.hilbri.assist.datamodel.model.IOAdapter)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case MappingPackage.IO_ADAPTER__PROTECTION_LEVEL:
				...
				return;
			case MappingPackage.IO_ADAPTER__REFERENCE_OBJECT:
				setReferenceObject((ch.hilbri.assist.datamodel.model.IOAdapter)null);
				return;
		}
