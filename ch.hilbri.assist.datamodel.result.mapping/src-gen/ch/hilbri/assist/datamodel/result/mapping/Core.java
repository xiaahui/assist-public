 ...
 * </p>
 * <ul>
 *   <li>{@link ch.hilbri.assist.datamodel.result.mapping.Core#getArchitecture <em>Architecture</em>}</li>
 *   <li>{@link ch.hilbri.assist.datamodel.result.mapping.Core#getCapacity <em>Capacity</em>}</li>
 *   <li>{@link ch.hilbri.assist.datamodel.result.mapping.Core#getUtilization <em>Utilization</em>}</li>
 *   <li>{@link ch.hilbri.assist.datamodel.result.mapping.Core#getRelativeUtilization <em>Relative Utilization</em>}</li>
 *   <li>{@link ch.hilbri.assist.datamodel.result.mapping.Core#getProcessor <em>Processor</em>}</li>
 *   <li>{@link ch.hilbri.assist.datamodel.result.mapping.Core#getThreads <em>Threads</em>}</li>
 *   <li>{@link ch.hilbri.assist.datamodel.result.mapping.Core#isNotUsed <em>Not Used</em>}</li>
 *   <li>{@link ch.hilbri.assist.datamodel.result.mapping.Core#getRemainingAbsoluteCapacity <em>Remaining Absolute Capacity</em>}</li>
 *   <li>{@link ch.hilbri.assist.datamodel.result.mapping.Core#getRemainingRelativeCapacity <em>Remaining Relative Capacity</em>}</li>
 * </ul>
 *
 * @see ch.hilbri.assist.datamodel.result.mapping.MappingPackage#getCore()
 * @model
 * @generated
 */
public interface Core extends HardwareElement {
	 ...
	 * @see ch.hilbri.assist.datamodel.result.mapping.MappingPackage#getCore_Architecture()
	 * @model unique="false"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link ch.hilbri.assist.datamodel.result.mapping.Core#getArchitecture <em>Architecture</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setCapacity(int)
	 * @see ch.hilbri.assist.datamodel.result.mapping.MappingPackage#getCore_Capacity()
	 * @model unique="false"
	 * @generated
	 */
	int getCapacity();
	...
	/**
	 * Sets the value of the '{@link ch.hilbri.assist.datamodel.result.mapping.Core#getCapacity <em>Capacity</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ch.hilbri.assist.datamodel.result.mapping.MappingPackage#getCore_Utilization()
	 * @model unique="false"
	 * @generated
	 */
	int getUtilization();
	...
	/**
	 * Sets the value of the '{@link ch.hilbri.assist.datamodel.result.mapping.Core#getUtilization <em>Utilization</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ch.hilbri.assist.datamodel.result.mapping.MappingPackage#getCore_RelativeUtilization()
	 * @model unique="false" transient="true" changeable="false" volatile="true" derived="true"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel get='int _utilization = this.getUtilization();\ndouble _multiply = (((double) _utilization) * 100.0);\nint _capacity = this.getCapacity();\nreturn (_multiply / ((double) _capacity));'"
	 * @generated
	 */
	 ...
	 * It is bidirectional and its opposite is '{@link ch.hilbri.assist.datamodel.result.mapping.Processor#getCores <em>Cores</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see ch.hilbri.assist.datamodel.result.mapping.MappingPackage#getCore_Processor()
	...
	/**
	 * Sets the value of the '{@link ch.hilbri.assist.datamodel.result.mapping.Core#getProcessor <em>Processor</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ch.hilbri.assist.datamodel.result.mapping.MappingPackage#getCore_Threads()
	 * @model
	 * @generated
	 */
	 ...
	 * @see ch.hilbri.assist.datamodel.result.mapping.MappingPackage#getCore_NotUsed()
	 * @model unique="false" transient="true" changeable="false" volatile="true" derived="true"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel get='<%org.eclipse.emf.common.util.EList%><<%ch.hilbri.assist.datamodel.result.mapping.Thread%>> _threads = this.getThreads();\nreturn _threads.isEmpty();'"
	 * @generated
	 */
	boolean isNotUsed();
	 ...
	 * @see ch.hilbri.assist.datamodel.result.mapping.MappingPackage#getCore_RemainingAbsoluteCapacity()
	 * @model unique="false" transient="true" changeable="false" volatile="true" derived="true"
	 ...
	 * @see ch.hilbri.assist.datamodel.result.mapping.MappingPackage#getCore_RemainingRelativeCapacity()
	 * @model unique="false" transient="true" changeable="false" volatile="true" derived="true"
	 ...
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='return <%ch.hilbri.assist.datamodel.model.HardwareArchitectureLevelType%>.CORE;'"
	 * @generated
	 */
