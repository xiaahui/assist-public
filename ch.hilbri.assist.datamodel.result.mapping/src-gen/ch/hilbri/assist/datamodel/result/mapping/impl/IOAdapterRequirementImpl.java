 ...
 * <ul>
 *   <li>{@link ch.hilbri.assist.datamodel.result.mapping.impl.IOAdapterRequirementImpl#getAdapterType <em>Adapter Type</em>}</li>
 *   <li>{@link ch.hilbri.assist.datamodel.result.mapping.impl.IOAdapterRequirementImpl#getRequiredUnits <em>Required Units</em>}</li>
 *   <li>{@link ch.hilbri.assist.datamodel.result.mapping.impl.IOAdapterRequirementImpl#isIsSharedAllowed <em>Is Shared Allowed</em>}</li>
 *   <li>{@link ch.hilbri.assist.datamodel.result.mapping.impl.IOAdapterRequirementImpl#isIsExclusiveOnly <em>Is Exclusive Only</em>}</li>
 *   <li>{@link ch.hilbri.assist.datamodel.result.mapping.impl.IOAdapterRequirementImpl#getReferenceObject <em>Reference Object</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IOAdapterRequirementImpl extends MinimalEObjectImpl.Container implements IOAdapterRequirement {
	 ...
	 * @ordered
	 */
	protected ch.hilbri.assist.datamodel.model.IOAdapterRequirement referenceObject;
	 ...
	 * @generated
	 */
	public ch.hilbri.assist.datamodel.model.IOAdapterRequirement getReferenceObject() {
		if (referenceObject != null && referenceObject.eIsProxy()) {
			InternalEObject oldReferenceObject = (InternalEObject)referenceObject;
			referenceObject = (ch.hilbri.assist.datamodel.model.IOAdapterRequirement)eResolveProxy(oldReferenceObject);
	 ...
	 * @generated
	 */
	public ch.hilbri.assist.datamodel.model.IOAdapterRequirement basicGetReferenceObject() {
		return referenceObject;
	}
	 ...
	 * @generated
	 */
	public void setReferenceObject(ch.hilbri.assist.datamodel.model.IOAdapterRequirement newReferenceObject) {
		ch.hilbri.assist.datamodel.model.IOAdapterRequirement oldReferenceObject = referenceObject;
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case MappingPackage.IO_ADAPTER_REQUIREMENT__IS_EXCLUSIVE_ONLY:
				...
				return;
			case MappingPackage.IO_ADAPTER_REQUIREMENT__REFERENCE_OBJECT:
				setReferenceObject((ch.hilbri.assist.datamodel.model.IOAdapterRequirement)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case MappingPackage.IO_ADAPTER_REQUIREMENT__IS_EXCLUSIVE_ONLY:
				...
				return;
			case MappingPackage.IO_ADAPTER_REQUIREMENT__REFERENCE_OBJECT:
				setReferenceObject((ch.hilbri.assist.datamodel.model.IOAdapterRequirement)null);
				return;
		}
