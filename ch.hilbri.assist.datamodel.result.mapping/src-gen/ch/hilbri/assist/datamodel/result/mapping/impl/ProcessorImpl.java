 ...
 * </p>
 * <ul>
 *   <li>{@link ch.hilbri.assist.datamodel.result.mapping.impl.ProcessorImpl#getManufacturer <em>Manufacturer</em>}</li>
 *   <li>{@link ch.hilbri.assist.datamodel.result.mapping.impl.ProcessorImpl#getProcessorType <em>Processor Type</em>}</li>
 *   <li>{@link ch.hilbri.assist.datamodel.result.mapping.impl.ProcessorImpl#getBoard <em>Board</em>}</li>
 *   <li>{@link ch.hilbri.assist.datamodel.result.mapping.impl.ProcessorImpl#getCores <em>Cores</em>}</li>
 *   <li>{@link ch.hilbri.assist.datamodel.result.mapping.impl.ProcessorImpl#getMetricParameters <em>Metric Parameters</em>}</li>
 *   <li>{@link ch.hilbri.assist.datamodel.result.mapping.impl.ProcessorImpl#isNotUsed <em>Not Used</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProcessorImpl extends HardwareElementImpl implements Processor {
	...
	public EList<MetricParameter> getMetricParameters() {
		if (metricParameters == null) {
			metricParameters = new EObjectContainmentEList<MetricParameter>(MetricParameter.class, this, MappingPackage.PROCESSOR__METRIC_PARAMETERS);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case MappingPackage.PROCESSOR__METRIC_PARAMETERS:
