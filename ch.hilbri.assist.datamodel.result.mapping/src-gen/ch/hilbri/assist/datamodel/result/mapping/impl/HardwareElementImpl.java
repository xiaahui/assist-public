 ...
 * </p>
 * <ul>
 *   <li>{@link ch.hilbri.assist.datamodel.result.mapping.impl.HardwareElementImpl#getName <em>Name</em>}</li>
 *   <li>{@link ch.hilbri.assist.datamodel.result.mapping.impl.HardwareElementImpl#getReferenceObject <em>Reference Object</em>}</li>
 * </ul>
 *
 * @generated
 */
public class HardwareElementImpl extends MinimalEObjectImpl.Container implements HardwareElement {
	 ...
	 * @ordered
	 */
	protected ch.hilbri.assist.datamodel.model.HardwareElement referenceObject;
	 ...
	 * @generated
	 */
	public ch.hilbri.assist.datamodel.model.HardwareElement getReferenceObject() {
		if (referenceObject != null && referenceObject.eIsProxy()) {
			InternalEObject oldReferenceObject = (InternalEObject)referenceObject;
			referenceObject = (ch.hilbri.assist.datamodel.model.HardwareElement)eResolveProxy(oldReferenceObject);
	 ...
	 * @generated
	 */
	public ch.hilbri.assist.datamodel.model.HardwareElement basicGetReferenceObject() {
		return referenceObject;
	}
	 ...
	 * @generated
	 */
	public void setReferenceObject(ch.hilbri.assist.datamodel.model.HardwareElement newReferenceObject) {
		ch.hilbri.assist.datamodel.model.HardwareElement oldReferenceObject = referenceObject;
	...
	public int getMetricParameterValue(final String parameterName) {
		ch.hilbri.assist.datamodel.model.HardwareElement _referenceObject = this.getReferenceObject();
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case MappingPackage.HARDWARE_ELEMENT__NAME:
				...
				return;
			case MappingPackage.HARDWARE_ELEMENT__REFERENCE_OBJECT:
				setReferenceObject((ch.hilbri.assist.datamodel.model.HardwareElement)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case MappingPackage.HARDWARE_ELEMENT__NAME:
				...
				return;
			case MappingPackage.HARDWARE_ELEMENT__REFERENCE_OBJECT:
				setReferenceObject((ch.hilbri.assist.datamodel.model.HardwareElement)null);
				return;
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case MappingPackage.HARDWARE_ELEMENT___GET_METRIC_PARAMETER_VALUE__STRING:
