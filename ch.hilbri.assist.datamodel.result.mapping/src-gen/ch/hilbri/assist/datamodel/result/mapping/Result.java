 ...
 *   <li>{@link ch.hilbri.assist.datamodel.result.mapping.Result#getMappingsForHardwareElements <em>Mappings For Hardware Elements</em>}</li>
...
public interface Result extends EObject, Comparable<Result> {
	...
	/**
	 * Returns the value of the '<em><b>Mappings For Hardware Elements</b></em>' attribute.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Mappings For Hardware Elements</em>' attribute isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Mappings For Hardware Elements</em>' attribute.
	 * @see #setMappingsForHardwareElements(HashMap)
	 * @see ch.hilbri.assist.datamodel.result.mapping.MappingPackage#getResult_MappingsForHardwareElements()
	 * @model unique="false" dataType="ch.hilbri.assist.datamodel.result.mapping.HardwareElementMappingsMapType"
	 * @generated
	 */
	HashMap<HardwareElement, EList<EqInterface>> getMappingsForHardwareElements();

	/**
	 * Sets the value of the '{@link ch.hilbri.assist.datamodel.result.mapping.Result#getMappingsForHardwareElements <em>Mappings For Hardware Elements</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param value the new value of the '<em>Mappings For Hardware Elements</em>' attribute.
	 * @see #getMappingsForHardwareElements()
	 * @generated
	 */
	void setMappingsForHardwareElements(HashMap<HardwareElement, EList<EqInterface>> value);
