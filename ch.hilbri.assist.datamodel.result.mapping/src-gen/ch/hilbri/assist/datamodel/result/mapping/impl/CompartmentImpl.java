 ...
 * <ul>
 *   <li>{@link ch.hilbri.assist.datamodel.result.mapping.impl.CompartmentImpl#getManufacturer <em>Manufacturer</em>}</li>
 *   <li>{@link ch.hilbri.assist.datamodel.result.mapping.impl.CompartmentImpl#getPowerSupply <em>Power Supply</em>}</li>
 *   <li>{@link ch.hilbri.assist.datamodel.result.mapping.impl.CompartmentImpl#getSide <em>Side</em>}</li>
 *   <li>{@link ch.hilbri.assist.datamodel.result.mapping.impl.CompartmentImpl#getZone <em>Zone</em>}</li>
 *   <li>{@link ch.hilbri.assist.datamodel.result.mapping.impl.CompartmentImpl#getBoxes <em>Boxes</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CompartmentImpl extends HardwareElementImpl implements Compartment {
	...
	protected EClass eStaticClass() {
		return MappingPackage.Literals.COMPARTMENT;
	}
	...
	public void setManufacturer(String newManufacturer) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MappingPackage.COMPARTMENT__MANUFACTURER, oldManufacturer, manufacturer));
	}
	...
	public void setPowerSupply(String newPowerSupply) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MappingPackage.COMPARTMENT__POWER_SUPPLY, oldPowerSupply, powerSupply));
	}
	...
	public void setSide(String newSide) {
		...
		side = newSide;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MappingPackage.COMPARTMENT__SIDE, oldSide, side));
	}
	...
	public void setZone(String newZone) {
		...
		zone = newZone;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MappingPackage.COMPARTMENT__ZONE, oldZone, zone));
	}
	...
	public EList<Box> getBoxes() {
		if (boxes == null) {
			boxes = new EObjectContainmentWithInverseEList<Box>(Box.class, this, MappingPackage.COMPARTMENT__BOXES, MappingPackage.BOX__COMPARTMENT);
		}
		return boxes;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MappingPackage.COMPARTMENT__BOXES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MappingPackage.COMPARTMENT__MANUFACTURER:
				return getManufacturer();
			case MappingPackage.COMPARTMENT__POWER_SUPPLY:
				return getPowerSupply();
			case MappingPackage.COMPARTMENT__SIDE:
				return getSide();
			case MappingPackage.COMPARTMENT__ZONE:
				return getZone();
			case MappingPackage.COMPARTMENT__BOXES:
				return getBoxes();
		}
