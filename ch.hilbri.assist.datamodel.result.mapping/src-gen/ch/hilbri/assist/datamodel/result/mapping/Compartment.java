 ...
 * </p>
 * <ul>
 *   <li>{@link ch.hilbri.assist.datamodel.result.mapping.Compartment#getManufacturer <em>Manufacturer</em>}</li>
 *   <li>{@link ch.hilbri.assist.datamodel.result.mapping.Compartment#getPowerSupply <em>Power Supply</em>}</li>
 *   <li>{@link ch.hilbri.assist.datamodel.result.mapping.Compartment#getSide <em>Side</em>}</li>
 *   <li>{@link ch.hilbri.assist.datamodel.result.mapping.Compartment#getZone <em>Zone</em>}</li>
 *   <li>{@link ch.hilbri.assist.datamodel.result.mapping.Compartment#getBoxes <em>Boxes</em>}</li>
 * </ul>
 *
 * @see ch.hilbri.assist.datamodel.result.mapping.MappingPackage#getCompartment()
 * @model
 * @generated
 */
public interface Compartment extends HardwareElement {
	 ...
	 * @see ch.hilbri.assist.datamodel.result.mapping.MappingPackage#getCompartment_Manufacturer()
	 * @model unique="false"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link ch.hilbri.assist.datamodel.result.mapping.Compartment#getManufacturer <em>Manufacturer</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ch.hilbri.assist.datamodel.result.mapping.MappingPackage#getCompartment_PowerSupply()
	 * @model unique="false"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link ch.hilbri.assist.datamodel.result.mapping.Compartment#getPowerSupply <em>Power Supply</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setSide(String)
	 * @see ch.hilbri.assist.datamodel.result.mapping.MappingPackage#getCompartment_Side()
	 * @model unique="false"
	 * @generated
	 */
	String getSide();
	...
	/**
	 * Sets the value of the '{@link ch.hilbri.assist.datamodel.result.mapping.Compartment#getSide <em>Side</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setZone(String)
	 * @see ch.hilbri.assist.datamodel.result.mapping.MappingPackage#getCompartment_Zone()
	 * @model unique="false"
	 * @generated
	 */
	String getZone();
	...
	/**
	 * Sets the value of the '{@link ch.hilbri.assist.datamodel.result.mapping.Compartment#getZone <em>Zone</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link ch.hilbri.assist.datamodel.result.mapping.Box}.
	 * It is bidirectional and its opposite is '{@link ch.hilbri.assist.datamodel.result.mapping.Box#getCompartment <em>Compartment</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see ch.hilbri.assist.datamodel.result.mapping.MappingPackage#getCompartment_Boxes()
	 ...
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='final <%org.eclipse.emf.common.util.BasicEList%><<%ch.hilbri.assist.datamodel.result.mapping.Board%>> list = new <%org.eclipse.emf.common.util.BasicEList%><<%ch.hilbri.assist.datamodel.result.mapping.Board%>>();\n<%org.eclipse.emf.common.util.EList%><<%ch.hilbri.assist.datamodel.result.mapping.Box%>> _boxes = this.getBoxes();\nfor (final <%ch.hilbri.assist.datamodel.result.mapping.Box%> b : _boxes)\n{\n\t<%org.eclipse.emf.common.util.EList%><<%ch.hilbri.assist.datamodel.result.mapping.Board%>> _boards = b.getBoards();\n\tlist.addAll(_boards);\n}\nreturn list;'"
	 * @generated
	 */
	 ...
	 * <!-- end-user-doc -->
	 * @model kind="operation" unique="false"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='return <%ch.hilbri.assist.datamodel.model.HardwareArchitectureLevelType%>.COMPARTMENT;'"
	 * @generated
	 */
