...
public class RAMCapacityTests extends AbstractMappingTest {
  ...
  public void testResult_A1_on_Core1_and_A2_on_Core2() {
    ...
    int _ramUtilization = _get_5.getRamUtilization();
    Assert.assertEquals(_ramUtilization, 70);
    EList<Board> _allBoards_2 = result.getAllBoards();
    Board _get_6 = _allBoards_2.get(0);
    int _ramCapacity = _get_6.getRamCapacity();
    Assert.assertEquals(_ramCapacity, 100);
    ...
    int _ramUtilization_1 = _get_8.getRamUtilization();
    Assert.assertEquals(_ramUtilization_1, 60);
    EList<Board> _allBoards_5 = result.getAllBoards();
    Board _get_9 = _allBoards_5.get(1);
    int _ramCapacity_1 = _get_9.getRamCapacity();
    Assert.assertEquals(_ramCapacity_1, 100);
  }
  ...
  public void testResult_A1_on_Core2_and_A2_on_Core1() {
    ...
    Board _get_5 = _allBoards_1.get(0);
    int _ramUtilization = _get_5.getRamUtilization();
    Assert.assertEquals(_ramUtilization, 60);
    EList<Board> _allBoards_2 = result.getAllBoards();
    Board _get_6 = _allBoards_2.get(0);
    int _ramCapacity = _get_6.getRamCapacity();
    Assert.assertEquals(_ramCapacity, 100);
    ...
    Board _get_8 = _allBoards_4.get(1);
    int _ramUtilization_1 = _get_8.getRamUtilization();
    Assert.assertEquals(_ramUtilization_1, 70);
    EList<Board> _allBoards_5 = result.getAllBoards();
    Board _get_9 = _allBoards_5.get(1);
    int _ramCapacity_1 = _get_9.getRamCapacity();
    Assert.assertEquals(_ramCapacity_1, 100);
